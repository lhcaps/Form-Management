...
export const BM_FIELD_MAP: BmFieldMap = Object.freeze({
  ...
  "BM-048": [
    ...
    { section: "agency", field: "name", from: "agency.name", transform: "upper" },
    { section: "document", field: "issueDate", from: "case.receivedDate", transform: "formatVnDate" },
    { section: "bailDecision", field: "decisionCode", from: "case.code" },
    ...
    { section: "offense", field: "articleNumber", from: "offense.legalArticle" },
    { section: "signature", field: "signerName", from: "assignment.official.fullName" },
  ],
  "BM-049": [
    { section: "agency", field: "parentName", from: "agency.parentName", transform: "upper" },
    { section: "agency", field: "name", from: "agency.name", transform: "upper" },
    { section: "document", field: "issueDate", from: "case.receivedDate", transform: "formatVnDate" },
    { section: "caseDecision", field: "decisionCode", from: "case.code" },
    { section: "accusedDecision", field: "personName", from: "person.fullName" },
    { section: "accusedDecision", field: "offenseName", from: "offense.name" },
    { section: "signature", field: "signerName", from: "assignment.official.fullName" },
  ],
  "BM-050": [
    { section: "agency", field: "parentName", from: "agency.parentName", transform: "upper" },
  ...
  "BM-027": [
    ...
    { section: "agency", field: "name", from: "agency.name", transform: "upper" },
    { section: "document", field: "issueDate", from: "case.receivedDate", transform: "formatVnDate" },
    { section: "originalDecision", field: "decisionCode", from: "case.code" },
    { section: "recipients", field: "recipientTo", from: "case.code" },
    { section: "originalDecision", field: "offenseName", from: "offense.name" },
    { section: "originalDecision", field: "articleClause", from: "offense.legalArticle" },
    { section: "signature", field: "signerName", from: "assignment.official.fullName" },
  ],
  "BM-028": [
    { section: "agency", field: "parentName", from: "agency.parentName", transform: "upper" },
