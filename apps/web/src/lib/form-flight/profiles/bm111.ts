 ...
 * contract `docs\audit\docx\contracts\locked\BM-111__33851c577165.contract.locked.json`.
 *
...
// promoted.
const BM111_REQUIRED_FIELD_PATHS = [] as const;

export const BM111_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-111",
  title: "Biểu mẫu BM-111",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM111_FIELD_PATHS,
  requiredFieldPaths: BM111_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-111 anchors must
...
registerFormFlightProfile(BM111_FORM_FLIGHT_PROFILE);
