 ...
 * contract `docs\audit\docx\contracts\locked\BM-112__109c846bbe17.contract.locked.json`.
 *
...
// promoted.
const BM112_REQUIRED_FIELD_PATHS = [] as const;

export const BM112_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-112",
  title: "Biểu mẫu BM-112",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM112_FIELD_PATHS,
  requiredFieldPaths: BM112_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-112 anchors must
...
registerFormFlightProfile(BM112_FORM_FLIGHT_PROFILE);
