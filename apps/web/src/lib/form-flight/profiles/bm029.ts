 ...
 * contract `docs\audit\docx\contracts\locked\BM-029__0bf65fba614a.contract.locked.json`.
 *
...
// promoted.
const BM029_REQUIRED_FIELD_PATHS = [] as const;

export const BM029_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-029",
  title: "Biểu mẫu BM-029",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM029_FIELD_PATHS,
  requiredFieldPaths: BM029_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-029 anchors must
...
registerFormFlightProfile(BM029_FORM_FLIGHT_PROFILE);
