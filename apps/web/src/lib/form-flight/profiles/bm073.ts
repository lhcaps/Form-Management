 ...
 * contract `docs\audit\docx\contracts\locked\BM-073__e412fccad227.contract.locked.json`.
 *
...
// promoted.
const BM073_REQUIRED_FIELD_PATHS = [] as const;

export const BM073_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-073",
  title: "Biểu mẫu BM-073",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM073_FIELD_PATHS,
  requiredFieldPaths: BM073_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-073 anchors must
...
registerFormFlightProfile(BM073_FORM_FLIGHT_PROFILE);
