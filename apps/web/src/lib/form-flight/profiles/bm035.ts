 ...
 * contract `docs\audit\docx\contracts\locked\BM-035__be0035952622.contract.locked.json`.
 *
...
// promoted.
const BM035_REQUIRED_FIELD_PATHS = [] as const;

export const BM035_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-035",
  title: "Biểu mẫu BM-035",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM035_FIELD_PATHS,
  requiredFieldPaths: BM035_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-035 anchors must
...
registerFormFlightProfile(BM035_FORM_FLIGHT_PROFILE);
