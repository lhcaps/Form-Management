 ...
 * contract `docs\audit\docx\contracts\locked\BM-120__e702d429a0f3.contract.locked.json`.
 *
...
// promoted.
const BM120_REQUIRED_FIELD_PATHS = [] as const;

export const BM120_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-120",
  title: "Biểu mẫu BM-120",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM120_FIELD_PATHS,
  requiredFieldPaths: BM120_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-120 anchors must
...
registerFormFlightProfile(BM120_FORM_FLIGHT_PROFILE);
