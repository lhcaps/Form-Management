 ...
 * contract `docs\audit\docx\contracts\locked\BM-128__8eab646ee06f.contract.locked.json`.
 *
...
// promoted.
const BM128_REQUIRED_FIELD_PATHS = [] as const;

export const BM128_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-128",
  title: "Biểu mẫu BM-128",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM128_FIELD_PATHS,
  requiredFieldPaths: BM128_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-128 anchors must
...
registerFormFlightProfile(BM128_FORM_FLIGHT_PROFILE);
