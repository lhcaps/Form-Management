 ...
 * contract `docs\audit\docx\contracts\locked\BM-009__ad542fd7bc45.contract.locked.json`.
 *
...
// promoted.
const BM009_REQUIRED_FIELD_PATHS = [] as const;

export const BM009_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-009",
  title: "Biểu mẫu BM-009",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM009_FIELD_PATHS,
  requiredFieldPaths: BM009_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-009 anchors must
...
registerFormFlightProfile(BM009_FORM_FLIGHT_PROFILE);
