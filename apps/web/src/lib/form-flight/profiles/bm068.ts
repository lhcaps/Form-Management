 ...
 * contract `docs\audit\docx\contracts\locked\BM-068__6c1275cc752e.contract.locked.json`.
 *
...
// promoted.
const BM068_REQUIRED_FIELD_PATHS = [] as const;

export const BM068_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-068",
  title: "Biểu mẫu BM-068",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM068_FIELD_PATHS,
  requiredFieldPaths: BM068_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-068 anchors must
...
registerFormFlightProfile(BM068_FORM_FLIGHT_PROFILE);
