 ...
 * contract `docs\audit\docx\contracts\locked\BM-196__0c6aec084a26.contract.locked.json`.
 *
...
// promoted.
const BM196_REQUIRED_FIELD_PATHS = [] as const;

export const BM196_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-196",
  title: "Biểu mẫu BM-196",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM196_FIELD_PATHS,
  requiredFieldPaths: BM196_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-196 anchors must
...
registerFormFlightProfile(BM196_FORM_FLIGHT_PROFILE);
