 ...
 * contract `docs\audit\docx\contracts\locked\BM-010__3814cd2b4bcf.contract.locked.json`.
 *
...
// promoted.
const BM010_REQUIRED_FIELD_PATHS = [] as const;

export const BM010_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-010",
  title: "Biểu mẫu BM-010",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM010_FIELD_PATHS,
  requiredFieldPaths: BM010_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-010 anchors must
...
registerFormFlightProfile(BM010_FORM_FLIGHT_PROFILE);
