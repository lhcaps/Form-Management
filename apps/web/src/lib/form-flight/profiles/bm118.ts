 ...
 * contract `docs\audit\docx\contracts\locked\BM-118__7d13f5eae86d.contract.locked.json`.
 *
...
// promoted.
const BM118_REQUIRED_FIELD_PATHS = [] as const;

export const BM118_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-118",
  title: "Biểu mẫu BM-118",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM118_FIELD_PATHS,
  requiredFieldPaths: BM118_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-118 anchors must
...
registerFormFlightProfile(BM118_FORM_FLIGHT_PROFILE);
