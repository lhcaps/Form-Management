 ...
 * contract `docs\audit\docx\contracts\locked\BM-179__186c49575a2e.contract.locked.json`.
 *
...
// promoted.
const BM179_REQUIRED_FIELD_PATHS = [] as const;

export const BM179_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-179",
  title: "Biểu mẫu BM-179",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM179_FIELD_PATHS,
  requiredFieldPaths: BM179_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-179 anchors must
...
registerFormFlightProfile(BM179_FORM_FLIGHT_PROFILE);
