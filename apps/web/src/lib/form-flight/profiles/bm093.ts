 ...
 * contract `docs\audit\docx\contracts\locked\BM-093__7273ce5a66b8.contract.locked.json`.
 *
...
// promoted.
const BM093_REQUIRED_FIELD_PATHS = [] as const;

export const BM093_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-093",
  title: "Biểu mẫu BM-093",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM093_FIELD_PATHS,
  requiredFieldPaths: BM093_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-093 anchors must
...
registerFormFlightProfile(BM093_FORM_FLIGHT_PROFILE);
