 ...
 * contract `docs\audit\docx\contracts\locked\BM-077__99d7843f9f9e.contract.locked.json`.
 *
...
// promoted.
const BM077_REQUIRED_FIELD_PATHS = [] as const;

export const BM077_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-077",
  title: "Biểu mẫu BM-077",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM077_FIELD_PATHS,
  requiredFieldPaths: BM077_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-077 anchors must
...
registerFormFlightProfile(BM077_FORM_FLIGHT_PROFILE);
