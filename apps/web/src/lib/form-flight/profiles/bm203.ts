 ...
 * contract `docs\audit\docx\contracts\locked\BM-203__7572e687ae0f.contract.locked.json`.
 *
...
// promoted.
const BM203_REQUIRED_FIELD_PATHS = [] as const;

export const BM203_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-203",
  title: "Biểu mẫu BM-203",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM203_FIELD_PATHS,
  requiredFieldPaths: BM203_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-203 anchors must
...
registerFormFlightProfile(BM203_FORM_FLIGHT_PROFILE);
