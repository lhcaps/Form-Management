 ...
 * contract `docs\audit\docx\contracts\locked\BM-042__a4da3c74d437.contract.locked.json`.
 *
...
// promoted.
const BM042_REQUIRED_FIELD_PATHS = [] as const;

export const BM042_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-042",
  title: "Biểu mẫu BM-042",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM042_FIELD_PATHS,
  requiredFieldPaths: BM042_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-042 anchors must
...
registerFormFlightProfile(BM042_FORM_FLIGHT_PROFILE);
