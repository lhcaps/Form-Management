 ...
 * contract `docs\audit\docx\contracts\locked\BM-213__33383be18132.contract.locked.json`.
 *
...
// promoted.
const BM213_REQUIRED_FIELD_PATHS = [] as const;

export const BM213_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-213",
  title: "Biểu mẫu BM-213",
  ...
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-213 anchors must
