 ...
 * contract `docs\audit\docx\contracts\locked\BM-159__d95eb7bda8e3.contract.locked.json`.
 *
...
// promoted.
const BM159_REQUIRED_FIELD_PATHS = [] as const;

export const BM159_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-159",
  title: "Biểu mẫu BM-159",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM159_FIELD_PATHS,
  requiredFieldPaths: BM159_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-159 anchors must
...
registerFormFlightProfile(BM159_FORM_FLIGHT_PROFILE);
