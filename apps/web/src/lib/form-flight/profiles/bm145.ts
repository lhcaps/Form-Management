 ...
 * contract `docs\audit\docx\contracts\locked\BM-145__fc22267f4a63.contract.locked.json`.
 *
...
// promoted.
const BM145_REQUIRED_FIELD_PATHS = [] as const;

export const BM145_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-145",
  title: "Biểu mẫu BM-145",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM145_FIELD_PATHS,
  requiredFieldPaths: BM145_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-145 anchors must
...
registerFormFlightProfile(BM145_FORM_FLIGHT_PROFILE);
