 ...
 * contract `docs\audit\docx\contracts\locked\BM-154__618d13a959ca.contract.locked.json`.
 *
...
// promoted.
const BM154_REQUIRED_FIELD_PATHS = [] as const;

export const BM154_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-154",
  title: "Biểu mẫu BM-154",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM154_FIELD_PATHS,
  requiredFieldPaths: BM154_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-154 anchors must
...
registerFormFlightProfile(BM154_FORM_FLIGHT_PROFILE);
