 ...
 * contract `docs\audit\docx\contracts\locked\BM-151__d3ead7c40b56.contract.locked.json`.
 *
...
// promoted.
const BM151_REQUIRED_FIELD_PATHS = [] as const;

export const BM151_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-151",
  title: "Biểu mẫu BM-151",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM151_FIELD_PATHS,
  requiredFieldPaths: BM151_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-151 anchors must
...
registerFormFlightProfile(BM151_FORM_FLIGHT_PROFILE);
