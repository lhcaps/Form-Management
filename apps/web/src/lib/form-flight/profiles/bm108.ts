 ...
 * contract `docs\audit\docx\contracts\locked\BM-108__baea4e0f603e.contract.locked.json`.
 *
...
// promoted.
const BM108_REQUIRED_FIELD_PATHS = [] as const;

export const BM108_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-108",
  title: "Biểu mẫu BM-108",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM108_FIELD_PATHS,
  requiredFieldPaths: BM108_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-108 anchors must
...
registerFormFlightProfile(BM108_FORM_FLIGHT_PROFILE);
