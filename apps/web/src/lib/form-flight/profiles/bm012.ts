 ...
 * contract `docs\audit\docx\contracts\locked\BM-012__7733d5ac8e86.contract.locked.json`.
 *
...
// promoted.
const BM012_REQUIRED_FIELD_PATHS = [] as const;

export const BM012_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-012",
  title: "Biểu mẫu BM-012",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM012_FIELD_PATHS,
  requiredFieldPaths: BM012_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-012 anchors must
...
registerFormFlightProfile(BM012_FORM_FLIGHT_PROFILE);
