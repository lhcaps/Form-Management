 ...
 * contract `docs\audit\docx\contracts\locked\BM-113__2651c6185250.contract.locked.json`.
 *
...
// promoted.
const BM113_REQUIRED_FIELD_PATHS = [] as const;

export const BM113_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-113",
  title: "Biểu mẫu BM-113",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM113_FIELD_PATHS,
  requiredFieldPaths: BM113_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-113 anchors must
...
registerFormFlightProfile(BM113_FORM_FLIGHT_PROFILE);
