 ...
 * contract `docs\audit\docx\contracts\locked\BM-024__575a6d8e9173.contract.locked.json`.
 *
...
// promoted.
const BM024_REQUIRED_FIELD_PATHS = [] as const;

export const BM024_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-024",
  title: "Biểu mẫu BM-024",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM024_FIELD_PATHS,
  requiredFieldPaths: BM024_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-024 anchors must
...
registerFormFlightProfile(BM024_FORM_FLIGHT_PROFILE);
