 ...
 * contract `docs\audit\docx\contracts\locked\BM-022__13d342bdfc56.contract.locked.json`.
 *
...
// promoted.
const BM022_REQUIRED_FIELD_PATHS = [] as const;

export const BM022_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-022",
  title: "Biểu mẫu BM-022",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM022_FIELD_PATHS,
  requiredFieldPaths: BM022_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-022 anchors must
...
registerFormFlightProfile(BM022_FORM_FLIGHT_PROFILE);
