 ...
 * contract `docs\audit\docx\contracts\locked\BM-070__e63499f6fc20.contract.locked.json`.
 *
...
// promoted.
const BM070_REQUIRED_FIELD_PATHS = [] as const;

export const BM070_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-070",
  title: "Biểu mẫu BM-070",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM070_FIELD_PATHS,
  requiredFieldPaths: BM070_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-070 anchors must
...
registerFormFlightProfile(BM070_FORM_FLIGHT_PROFILE);
