 ...
 * contract `docs\audit\docx\contracts\locked\BM-184__fb1c01087fa5.contract.locked.json`.
 *
...
// promoted.
const BM184_REQUIRED_FIELD_PATHS = [] as const;

export const BM184_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-184",
  title: "Biểu mẫu BM-184",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM184_FIELD_PATHS,
  requiredFieldPaths: BM184_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-184 anchors must
...
registerFormFlightProfile(BM184_FORM_FLIGHT_PROFILE);
