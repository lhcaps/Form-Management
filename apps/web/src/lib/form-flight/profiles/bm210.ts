 ...
 * contract `docs\audit\docx\contracts\locked\BM-210__7266a312afb8.contract.locked.json`.
 *
...
// promoted.
const BM210_REQUIRED_FIELD_PATHS = [] as const;

export const BM210_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-210",
  title: "Biểu mẫu BM-210",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM210_FIELD_PATHS,
  requiredFieldPaths: BM210_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-210 anchors must
...
registerFormFlightProfile(BM210_FORM_FLIGHT_PROFILE);
