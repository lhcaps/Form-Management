 ...
 * contract `docs\audit\docx\contracts\locked\BM-178__7f2719dcacc7.contract.locked.json`.
 *
...
// promoted.
const BM178_REQUIRED_FIELD_PATHS = [] as const;

export const BM178_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-178",
  title: "Biểu mẫu BM-178",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM178_FIELD_PATHS,
  requiredFieldPaths: BM178_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-178 anchors must
...
registerFormFlightProfile(BM178_FORM_FLIGHT_PROFILE);
