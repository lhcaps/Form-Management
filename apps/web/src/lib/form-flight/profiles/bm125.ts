 ...
 * contract `docs\audit\docx\contracts\locked\BM-125__77ec214513fb.contract.locked.json`.
 *
...
// promoted.
const BM125_REQUIRED_FIELD_PATHS = [] as const;

export const BM125_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-125",
  title: "Biểu mẫu BM-125",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM125_FIELD_PATHS,
  requiredFieldPaths: BM125_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-125 anchors must
...
registerFormFlightProfile(BM125_FORM_FLIGHT_PROFILE);
