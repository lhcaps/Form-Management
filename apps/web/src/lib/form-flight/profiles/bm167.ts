 ...
 * contract `docs\audit\docx\contracts\locked\BM-167__70817b325370.contract.locked.json`.
 *
...
// promoted.
const BM167_REQUIRED_FIELD_PATHS = [] as const;

export const BM167_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-167",
  title: "Biểu mẫu BM-167",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM167_FIELD_PATHS,
  requiredFieldPaths: BM167_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-167 anchors must
...
registerFormFlightProfile(BM167_FORM_FLIGHT_PROFILE);
