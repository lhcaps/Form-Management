 ...
 * contract `docs\audit\docx\contracts\locked\BM-100__a359d20c8fed.contract.locked.json`.
 *
...
// promoted.
const BM100_REQUIRED_FIELD_PATHS = [] as const;

export const BM100_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-100",
  title: "Biểu mẫu BM-100",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM100_FIELD_PATHS,
  requiredFieldPaths: BM100_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-100 anchors must
...
registerFormFlightProfile(BM100_FORM_FLIGHT_PROFILE);
