 ...
 * contract `docs\audit\docx\contracts\locked\BM-025__5dcf0eb7f481.contract.locked.json`.
 *
...
// promoted.
const BM025_REQUIRED_FIELD_PATHS = [] as const;

export const BM025_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-025",
  title: "Biểu mẫu BM-025",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM025_FIELD_PATHS,
  requiredFieldPaths: BM025_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-025 anchors must
...
registerFormFlightProfile(BM025_FORM_FLIGHT_PROFILE);
