 ...
 * contract `docs\audit\docx\contracts\locked\BM-085__ae0054d1db43.contract.locked.json`.
 *
...
// promoted.
const BM085_REQUIRED_FIELD_PATHS = [] as const;

export const BM085_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-085",
  title: "Biểu mẫu BM-085",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM085_FIELD_PATHS,
  requiredFieldPaths: BM085_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-085 anchors must
...
registerFormFlightProfile(BM085_FORM_FLIGHT_PROFILE);
