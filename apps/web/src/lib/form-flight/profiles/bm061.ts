 ...
 * contract `docs\audit\docx\contracts\locked\BM-061__ec44550246e9.contract.locked.json`.
 *
...
// promoted.
const BM061_REQUIRED_FIELD_PATHS = [] as const;

export const BM061_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-061",
  title: "Biểu mẫu BM-061",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM061_FIELD_PATHS,
  requiredFieldPaths: BM061_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-061 anchors must
...
registerFormFlightProfile(BM061_FORM_FLIGHT_PROFILE);
