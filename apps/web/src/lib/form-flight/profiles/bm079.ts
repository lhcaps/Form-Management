 ...
 * contract `docs\audit\docx\contracts\locked\BM-079__80698c347564.contract.locked.json`.
 *
...
// promoted.
const BM079_REQUIRED_FIELD_PATHS = [] as const;

export const BM079_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-079",
  title: "Biểu mẫu BM-079",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM079_FIELD_PATHS,
  requiredFieldPaths: BM079_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-079 anchors must
...
registerFormFlightProfile(BM079_FORM_FLIGHT_PROFILE);
