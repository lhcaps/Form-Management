 ...
 * contract `docs\audit\docx\contracts\locked\BM-212__b1bab1e5a854.contract.locked.json`.
 *
...
// promoted.
const BM212_REQUIRED_FIELD_PATHS = [] as const;

export const BM212_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-212",
  title: "Biểu mẫu BM-212",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM212_FIELD_PATHS,
  requiredFieldPaths: BM212_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-212 anchors must
...
registerFormFlightProfile(BM212_FORM_FLIGHT_PROFILE);
