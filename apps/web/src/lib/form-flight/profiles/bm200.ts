 ...
 * contract `docs\audit\docx\contracts\locked\BM-200__d340f628394e.contract.locked.json`.
 *
...
// promoted.
const BM200_REQUIRED_FIELD_PATHS = [] as const;

export const BM200_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-200",
  title: "Biểu mẫu BM-200",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM200_FIELD_PATHS,
  requiredFieldPaths: BM200_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-200 anchors must
...
registerFormFlightProfile(BM200_FORM_FLIGHT_PROFILE);
