 ...
 * contract `docs\audit\docx\contracts\locked\BM-006__87ff96f9a866.contract.locked.json`.
 *
...
// promoted.
const BM006_REQUIRED_FIELD_PATHS = [] as const;

export const BM006_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-006",
  title: "Biểu mẫu BM-006",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM006_FIELD_PATHS,
  requiredFieldPaths: BM006_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-006 anchors must
...
registerFormFlightProfile(BM006_FORM_FLIGHT_PROFILE);
