 ...
 * contract `docs\audit\docx\contracts\locked\BM-105__c83181e6b64b.contract.locked.json`.
 *
...
// promoted.
const BM105_REQUIRED_FIELD_PATHS = [] as const;

export const BM105_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-105",
  title: "Biểu mẫu BM-105",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM105_FIELD_PATHS,
  requiredFieldPaths: BM105_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-105 anchors must
...
registerFormFlightProfile(BM105_FORM_FLIGHT_PROFILE);
