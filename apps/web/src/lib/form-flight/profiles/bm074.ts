 ...
 * contract `docs\audit\docx\contracts\locked\BM-074__e7b3ef2ccb68.contract.locked.json`.
 *
...
// promoted.
const BM074_REQUIRED_FIELD_PATHS = [] as const;

export const BM074_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-074",
  title: "Biểu mẫu BM-074",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM074_FIELD_PATHS,
  requiredFieldPaths: BM074_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-074 anchors must
...
registerFormFlightProfile(BM074_FORM_FLIGHT_PROFILE);
