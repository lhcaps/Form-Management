 ...
 * contract `docs\audit\docx\contracts\locked\BM-036__6f4466480a94.contract.locked.json`.
 *
...
// promoted.
const BM036_REQUIRED_FIELD_PATHS = [] as const;

export const BM036_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-036",
  title: "Biểu mẫu BM-036",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM036_FIELD_PATHS,
  requiredFieldPaths: BM036_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-036 anchors must
...
registerFormFlightProfile(BM036_FORM_FLIGHT_PROFILE);
