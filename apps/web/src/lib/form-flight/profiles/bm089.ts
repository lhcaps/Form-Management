 ...
 * contract `docs\audit\docx\contracts\locked\BM-089__9d0d4280c6a1.contract.locked.json`.
 *
...
// promoted.
const BM089_REQUIRED_FIELD_PATHS = [] as const;

export const BM089_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-089",
  title: "Biểu mẫu BM-089",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM089_FIELD_PATHS,
  requiredFieldPaths: BM089_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-089 anchors must
...
registerFormFlightProfile(BM089_FORM_FLIGHT_PROFILE);
