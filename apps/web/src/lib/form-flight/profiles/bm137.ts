 ...
 * contract `docs\audit\docx\contracts\locked\BM-137__d2c569c61fb7.contract.locked.json`.
 *
...
// promoted.
const BM137_REQUIRED_FIELD_PATHS = [] as const;

export const BM137_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-137",
  title: "Biểu mẫu BM-137",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM137_FIELD_PATHS,
  requiredFieldPaths: BM137_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-137 anchors must
...
registerFormFlightProfile(BM137_FORM_FLIGHT_PROFILE);
