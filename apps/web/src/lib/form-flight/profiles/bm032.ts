 ...
 * contract `docs\audit\docx\contracts\locked\BM-032__cce50086cd38.contract.locked.json`.
 *
...
// promoted.
const BM032_REQUIRED_FIELD_PATHS = [] as const;

export const BM032_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-032",
  title: "Biểu mẫu BM-032",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM032_FIELD_PATHS,
  requiredFieldPaths: BM032_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-032 anchors must
...
registerFormFlightProfile(BM032_FORM_FLIGHT_PROFILE);
