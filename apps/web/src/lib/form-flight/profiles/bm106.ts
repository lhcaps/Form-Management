 ...
 * contract `docs\audit\docx\contracts\locked\BM-106__7f44c9dd261a.contract.locked.json`.
 *
...
// promoted.
const BM106_REQUIRED_FIELD_PATHS = [] as const;

export const BM106_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-106",
  title: "Biểu mẫu BM-106",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM106_FIELD_PATHS,
  requiredFieldPaths: BM106_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-106 anchors must
...
registerFormFlightProfile(BM106_FORM_FLIGHT_PROFILE);
