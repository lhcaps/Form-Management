 ...
 * contract `docs\audit\docx\contracts\locked\BM-138__bf31a1f547b0.contract.locked.json`.
 *
...
// promoted.
const BM138_REQUIRED_FIELD_PATHS = [] as const;

export const BM138_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-138",
  title: "Biểu mẫu BM-138",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM138_FIELD_PATHS,
  requiredFieldPaths: BM138_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-138 anchors must
...
registerFormFlightProfile(BM138_FORM_FLIGHT_PROFILE);
