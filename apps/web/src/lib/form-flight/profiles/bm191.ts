 ...
 * contract `docs\audit\docx\contracts\locked\BM-191__11335dc18806.contract.locked.json`.
 *
...
// promoted.
const BM191_REQUIRED_FIELD_PATHS = [] as const;

export const BM191_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-191",
  title: "Biểu mẫu BM-191",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM191_FIELD_PATHS,
  requiredFieldPaths: BM191_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-191 anchors must
...
registerFormFlightProfile(BM191_FORM_FLIGHT_PROFILE);
