 ...
 * contract `docs\audit\docx\contracts\locked\BM-197__37dda9913570.contract.locked.json`.
 *
...
// promoted.
const BM197_REQUIRED_FIELD_PATHS = [] as const;

export const BM197_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-197",
  title: "Biểu mẫu BM-197",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM197_FIELD_PATHS,
  requiredFieldPaths: BM197_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-197 anchors must
...
registerFormFlightProfile(BM197_FORM_FLIGHT_PROFILE);
