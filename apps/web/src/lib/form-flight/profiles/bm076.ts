 ...
 * contract `docs\audit\docx\contracts\locked\BM-076__cd44ed3c7e5d.contract.locked.json`.
 *
...
// promoted.
const BM076_REQUIRED_FIELD_PATHS = [] as const;

export const BM076_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-076",
  title: "Biểu mẫu BM-076",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM076_FIELD_PATHS,
  requiredFieldPaths: BM076_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-076 anchors must
...
registerFormFlightProfile(BM076_FORM_FLIGHT_PROFILE);
