 ...
 * contract `docs\audit\docx\contracts\locked\BM-126__2d8c3d38368b.contract.locked.json`.
 *
...
// promoted.
const BM126_REQUIRED_FIELD_PATHS = [] as const;

export const BM126_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-126",
  title: "Biểu mẫu BM-126",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM126_FIELD_PATHS,
  requiredFieldPaths: BM126_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-126 anchors must
...
registerFormFlightProfile(BM126_FORM_FLIGHT_PROFILE);
