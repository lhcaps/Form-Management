 ...
 * contract `docs\audit\docx\contracts\locked\BM-026__6e339663e320.contract.locked.json`.
 *
...
// promoted.
const BM026_REQUIRED_FIELD_PATHS = [] as const;

export const BM026_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-026",
  title: "Biểu mẫu BM-026",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM026_FIELD_PATHS,
  requiredFieldPaths: BM026_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-026 anchors must
...
registerFormFlightProfile(BM026_FORM_FLIGHT_PROFILE);
