 ...
 * contract `docs\audit\docx\contracts\locked\BM-124__1fca98cb2e90.contract.locked.json`.
 *
...
// promoted.
const BM124_REQUIRED_FIELD_PATHS = [] as const;

export const BM124_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-124",
  title: "Biểu mẫu BM-124",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM124_FIELD_PATHS,
  requiredFieldPaths: BM124_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-124 anchors must
...
registerFormFlightProfile(BM124_FORM_FLIGHT_PROFILE);
