 ...
 * contract `docs\audit\docx\contracts\locked\BM-161__5c910ef4adf5.contract.locked.json`.
 *
...
// promoted.
const BM161_REQUIRED_FIELD_PATHS = [] as const;

export const BM161_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-161",
  title: "Biểu mẫu BM-161",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM161_FIELD_PATHS,
  requiredFieldPaths: BM161_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-161 anchors must
...
registerFormFlightProfile(BM161_FORM_FLIGHT_PROFILE);
