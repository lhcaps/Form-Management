 ...
 * contract `docs\audit\docx\contracts\locked\BM-188__cb14348d184c.contract.locked.json`.
 *
...
// promoted.
const BM188_REQUIRED_FIELD_PATHS = [] as const;

export const BM188_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-188",
  title: "Biểu mẫu BM-188",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM188_FIELD_PATHS,
  requiredFieldPaths: BM188_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-188 anchors must
...
registerFormFlightProfile(BM188_FORM_FLIGHT_PROFILE);
