 ...
 * contract `docs\audit\docx\contracts\locked\BM-075__dc493cfb5fd3.contract.locked.json`.
 *
...
// promoted.
const BM075_REQUIRED_FIELD_PATHS = [] as const;

export const BM075_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-075",
  title: "Biểu mẫu BM-075",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM075_FIELD_PATHS,
  requiredFieldPaths: BM075_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-075 anchors must
...
registerFormFlightProfile(BM075_FORM_FLIGHT_PROFILE);
