 ...
 * contract `docs\audit\docx\contracts\locked\BM-121__a7983088c6ec.contract.locked.json`.
 *
...
// promoted.
const BM121_REQUIRED_FIELD_PATHS = [] as const;

export const BM121_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-121",
  title: "Biểu mẫu BM-121",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM121_FIELD_PATHS,
  requiredFieldPaths: BM121_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-121 anchors must
...
registerFormFlightProfile(BM121_FORM_FLIGHT_PROFILE);
