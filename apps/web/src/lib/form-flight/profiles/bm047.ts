 ...
 * contract `docs\audit\docx\contracts\locked\BM-047__ec7dc3448f91.contract.locked.json`.
 *
...
// promoted.
const BM047_REQUIRED_FIELD_PATHS = [] as const;

export const BM047_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-047",
  title: "Biểu mẫu BM-047",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM047_FIELD_PATHS,
  requiredFieldPaths: BM047_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-047 anchors must
...
registerFormFlightProfile(BM047_FORM_FLIGHT_PROFILE);
