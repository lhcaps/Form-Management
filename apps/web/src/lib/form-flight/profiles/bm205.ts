 ...
 * contract `docs\audit\docx\contracts\locked\BM-205__e6427663d551.contract.locked.json`.
 *
...
// promoted.
const BM205_REQUIRED_FIELD_PATHS = [] as const;

export const BM205_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-205",
  title: "Biểu mẫu BM-205",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM205_FIELD_PATHS,
  requiredFieldPaths: BM205_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-205 anchors must
...
registerFormFlightProfile(BM205_FORM_FLIGHT_PROFILE);
