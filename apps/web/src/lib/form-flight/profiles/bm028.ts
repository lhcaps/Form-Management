 ...
 * contract `docs\audit\docx\contracts\locked\BM-028__e895e0889340.contract.locked.json`.
 *
...
// promoted.
const BM028_REQUIRED_FIELD_PATHS = [] as const;

export const BM028_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-028",
  title: "Biểu mẫu BM-028",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM028_FIELD_PATHS,
  requiredFieldPaths: BM028_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-028 anchors must
...
registerFormFlightProfile(BM028_FORM_FLIGHT_PROFILE);
