 ...
 * contract `docs\audit\docx\contracts\locked\BM-103__665eb32a5626.contract.locked.json`.
 *
...
// promoted.
const BM103_REQUIRED_FIELD_PATHS = [] as const;

export const BM103_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-103",
  title: "Biểu mẫu BM-103",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM103_FIELD_PATHS,
  requiredFieldPaths: BM103_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-103 anchors must
...
registerFormFlightProfile(BM103_FORM_FLIGHT_PROFILE);
