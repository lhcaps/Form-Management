 ...
 * contract `docs\audit\docx\contracts\locked\BM-206__83dd8f078d92.contract.locked.json`.
 *
...
// promoted.
const BM206_REQUIRED_FIELD_PATHS = [] as const;

export const BM206_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-206",
  title: "Biểu mẫu BM-206",
  ...
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-206 anchors must
