 ...
 * contract `docs\audit\docx\contracts\locked\BM-003__bb64990bc49b.contract.locked.json`.
 *
...
// promoted.
const BM003_REQUIRED_FIELD_PATHS = [] as const;

export const BM003_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-003",
  title: "Biểu mẫu BM-003",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM003_FIELD_PATHS,
  requiredFieldPaths: BM003_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-003 anchors must
...
registerFormFlightProfile(BM003_FORM_FLIGHT_PROFILE);
