 ...
 * contract `docs\audit\docx\contracts\locked\BM-017__6b3cad999c61.contract.locked.json`.
 *
...
// promoted.
const BM017_REQUIRED_FIELD_PATHS = [] as const;

export const BM017_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-017",
  title: "Biểu mẫu BM-017",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM017_FIELD_PATHS,
  requiredFieldPaths: BM017_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-017 anchors must
...
registerFormFlightProfile(BM017_FORM_FLIGHT_PROFILE);
