 ...
 * contract `docs\audit\docx\contracts\locked\BM-040__aab092911088.contract.locked.json`.
 *
...
// promoted.
const BM040_REQUIRED_FIELD_PATHS = [] as const;

export const BM040_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-040",
  title: "Biểu mẫu BM-040",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM040_FIELD_PATHS,
  requiredFieldPaths: BM040_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-040 anchors must
...
registerFormFlightProfile(BM040_FORM_FLIGHT_PROFILE);
