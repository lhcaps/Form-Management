 ...
 * contract `docs\audit\docx\contracts\locked\BM-148__d4d27bb90141.contract.locked.json`.
 *
...
// promoted.
const BM148_REQUIRED_FIELD_PATHS = [] as const;

export const BM148_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-148",
  title: "Biểu mẫu BM-148",
  ...
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-148 anchors must
