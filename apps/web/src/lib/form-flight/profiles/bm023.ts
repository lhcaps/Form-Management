 ...
 * contract `docs\audit\docx\contracts\locked\BM-023__78e4f3906e4c.contract.locked.json`.
 *
...
// promoted.
const BM023_REQUIRED_FIELD_PATHS = [] as const;

export const BM023_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-023",
  title: "Biểu mẫu BM-023",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM023_FIELD_PATHS,
  requiredFieldPaths: BM023_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-023 anchors must
...
registerFormFlightProfile(BM023_FORM_FLIGHT_PROFILE);
