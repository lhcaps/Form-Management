 ...
 * contract `docs\audit\docx\contracts\locked\BM-195__0b409423eb38.contract.locked.json`.
 *
...
// promoted.
const BM195_REQUIRED_FIELD_PATHS = [] as const;

export const BM195_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-195",
  title: "Biểu mẫu BM-195",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM195_FIELD_PATHS,
  requiredFieldPaths: BM195_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-195 anchors must
...
registerFormFlightProfile(BM195_FORM_FLIGHT_PROFILE);
