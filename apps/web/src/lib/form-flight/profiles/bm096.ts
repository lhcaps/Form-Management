 ...
 * contract `docs\audit\docx\contracts\locked\BM-096__a50a08efa62f.contract.locked.json`.
 *
...
// promoted.
const BM096_REQUIRED_FIELD_PATHS = [] as const;

export const BM096_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-096",
  title: "Biểu mẫu BM-096",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM096_FIELD_PATHS,
  requiredFieldPaths: BM096_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-096 anchors must
...
registerFormFlightProfile(BM096_FORM_FLIGHT_PROFILE);
