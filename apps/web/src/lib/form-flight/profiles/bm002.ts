 ...
 * contract `docs\audit\docx\contracts\locked\BM-002__f78301178da7.contract.locked.json`.
 *
...
// promoted.
const BM002_REQUIRED_FIELD_PATHS = [] as const;

export const BM002_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-002",
  title: "Biểu mẫu BM-002",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM002_FIELD_PATHS,
  requiredFieldPaths: BM002_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-002 anchors must
...
registerFormFlightProfile(BM002_FORM_FLIGHT_PROFILE);
