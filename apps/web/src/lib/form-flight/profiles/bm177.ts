 ...
 * contract `docs\audit\docx\contracts\locked\BM-177__05be0ed97398.contract.locked.json`.
 *
...
// promoted.
const BM177_REQUIRED_FIELD_PATHS = [] as const;

export const BM177_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-177",
  title: "Biểu mẫu BM-177",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM177_FIELD_PATHS,
  requiredFieldPaths: BM177_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-177 anchors must
...
registerFormFlightProfile(BM177_FORM_FLIGHT_PROFILE);
