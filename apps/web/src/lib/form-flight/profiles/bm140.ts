 ...
 * contract `docs\audit\docx\contracts\locked\BM-140__13e1ade15acd.contract.locked.json`.
 *
...
// promoted.
const BM140_REQUIRED_FIELD_PATHS = [] as const;

export const BM140_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-140",
  title: "Biểu mẫu BM-140",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM140_FIELD_PATHS,
  requiredFieldPaths: BM140_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-140 anchors must
...
registerFormFlightProfile(BM140_FORM_FLIGHT_PROFILE);
