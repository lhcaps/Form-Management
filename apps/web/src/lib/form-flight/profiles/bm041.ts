 ...
 * contract `docs\audit\docx\contracts\locked\BM-041__9a027eeceb3a.contract.locked.json`.
 *
...
// promoted.
const BM041_REQUIRED_FIELD_PATHS = [] as const;

export const BM041_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-041",
  title: "Biểu mẫu BM-041",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM041_FIELD_PATHS,
  requiredFieldPaths: BM041_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-041 anchors must
...
registerFormFlightProfile(BM041_FORM_FLIGHT_PROFILE);
