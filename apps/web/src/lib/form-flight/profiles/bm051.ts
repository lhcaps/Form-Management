 ...
 * contract `docs\audit\docx\contracts\locked\BM-051__594c6c63b397.contract.locked.json`.
 *
...
// promoted.
const BM051_REQUIRED_FIELD_PATHS = [] as const;

export const BM051_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-051",
  title: "Biểu mẫu BM-051",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM051_FIELD_PATHS,
  requiredFieldPaths: BM051_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-051 anchors must
...
registerFormFlightProfile(BM051_FORM_FLIGHT_PROFILE);
