 ...
 * contract `docs\audit\docx\contracts\locked\BM-098__949d75027001.contract.locked.json`.
 *
...
// promoted.
const BM098_REQUIRED_FIELD_PATHS = [] as const;

export const BM098_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-098",
  title: "Biểu mẫu BM-098",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM098_FIELD_PATHS,
  requiredFieldPaths: BM098_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-098 anchors must
...
registerFormFlightProfile(BM098_FORM_FLIGHT_PROFILE);
