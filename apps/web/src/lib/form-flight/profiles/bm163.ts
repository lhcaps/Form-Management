 ...
 * contract `docs\audit\docx\contracts\locked\BM-163__61941122b9e4.contract.locked.json`.
 *
...
// promoted.
const BM163_REQUIRED_FIELD_PATHS = [] as const;

export const BM163_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-163",
  title: "Biểu mẫu BM-163",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM163_FIELD_PATHS,
  requiredFieldPaths: BM163_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-163 anchors must
...
registerFormFlightProfile(BM163_FORM_FLIGHT_PROFILE);
