 ...
 * contract `docs\audit\docx\contracts\locked\BM-199__e4724bd967ad.contract.locked.json`.
 *
...
// promoted.
const BM199_REQUIRED_FIELD_PATHS = [] as const;

export const BM199_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-199",
  title: "Biểu mẫu BM-199",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM199_FIELD_PATHS,
  requiredFieldPaths: BM199_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-199 anchors must
...
registerFormFlightProfile(BM199_FORM_FLIGHT_PROFILE);
