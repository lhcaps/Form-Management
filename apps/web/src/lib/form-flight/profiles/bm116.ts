 ...
 * contract `docs\audit\docx\contracts\locked\BM-116__23c45f530ed1.contract.locked.json`.
 *
...
// promoted.
const BM116_REQUIRED_FIELD_PATHS = [] as const;

export const BM116_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-116",
  title: "Biểu mẫu BM-116",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM116_FIELD_PATHS,
  requiredFieldPaths: BM116_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-116 anchors must
...
registerFormFlightProfile(BM116_FORM_FLIGHT_PROFILE);
