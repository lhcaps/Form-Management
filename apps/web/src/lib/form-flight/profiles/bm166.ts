 ...
 * contract `docs\audit\docx\contracts\locked\BM-166__d0762a0ffb28.contract.locked.json`.
 *
...
// promoted.
const BM166_REQUIRED_FIELD_PATHS = [] as const;

export const BM166_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-166",
  title: "Biểu mẫu BM-166",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM166_FIELD_PATHS,
  requiredFieldPaths: BM166_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-166 anchors must
...
registerFormFlightProfile(BM166_FORM_FLIGHT_PROFILE);
