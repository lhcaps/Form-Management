 ...
 * contract `docs\audit\docx\contracts\locked\BM-132__670b47f0b235.contract.locked.json`.
 *
...
// promoted.
const BM132_REQUIRED_FIELD_PATHS = [] as const;

export const BM132_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-132",
  title: "Biểu mẫu BM-132",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM132_FIELD_PATHS,
  requiredFieldPaths: BM132_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-132 anchors must
...
registerFormFlightProfile(BM132_FORM_FLIGHT_PROFILE);
