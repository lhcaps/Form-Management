 ...
 * contract `docs\audit\docx\contracts\locked\BM-193__e24862458ecb.contract.locked.json`.
 *
...
// promoted.
const BM193_REQUIRED_FIELD_PATHS = [] as const;

export const BM193_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-193",
  title: "Biểu mẫu BM-193",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM193_FIELD_PATHS,
  requiredFieldPaths: BM193_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-193 anchors must
...
registerFormFlightProfile(BM193_FORM_FLIGHT_PROFILE);
