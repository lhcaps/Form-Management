 ...
 * contract `docs\audit\docx\contracts\locked\BM-142__02d373abb354.contract.locked.json`.
 *
...
// promoted.
const BM142_REQUIRED_FIELD_PATHS = [] as const;

export const BM142_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-142",
  title: "Biểu mẫu BM-142",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM142_FIELD_PATHS,
  requiredFieldPaths: BM142_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-142 anchors must
...
registerFormFlightProfile(BM142_FORM_FLIGHT_PROFILE);
