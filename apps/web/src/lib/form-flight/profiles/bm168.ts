 ...
 * contract `docs\audit\docx\contracts\locked\BM-168__3369df5870b2.contract.locked.json`.
 *
...
// promoted.
const BM168_REQUIRED_FIELD_PATHS = [] as const;

export const BM168_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-168",
  title: "Biểu mẫu BM-168",
  ...
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-168 anchors must
