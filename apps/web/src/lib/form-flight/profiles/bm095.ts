 ...
 * contract `docs\audit\docx\contracts\locked\BM-095__83c3c1ef212f.contract.locked.json`.
 *
...
// promoted.
const BM095_REQUIRED_FIELD_PATHS = [] as const;

export const BM095_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-095",
  title: "Biểu mẫu BM-095",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM095_FIELD_PATHS,
  requiredFieldPaths: BM095_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-095 anchors must
...
registerFormFlightProfile(BM095_FORM_FLIGHT_PROFILE);
