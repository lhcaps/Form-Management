 ...
 * contract `docs\audit\docx\contracts\locked\BM-043__8eab35cfeedb.contract.locked.json`.
 *
...
// promoted.
const BM043_REQUIRED_FIELD_PATHS = [] as const;

export const BM043_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-043",
  title: "Biểu mẫu BM-043",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM043_FIELD_PATHS,
  requiredFieldPaths: BM043_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-043 anchors must
...
registerFormFlightProfile(BM043_FORM_FLIGHT_PROFILE);
