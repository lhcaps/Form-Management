 ...
 * contract `docs\audit\docx\contracts\locked\BM-139__23306e6022bd.contract.locked.json`.
 *
...
// promoted.
const BM139_REQUIRED_FIELD_PATHS = [] as const;

export const BM139_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-139",
  title: "Biểu mẫu BM-139",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM139_FIELD_PATHS,
  requiredFieldPaths: BM139_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-139 anchors must
...
registerFormFlightProfile(BM139_FORM_FLIGHT_PROFILE);
