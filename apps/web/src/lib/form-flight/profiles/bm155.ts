 ...
 * contract `docs\audit\docx\contracts\locked\BM-155__d89766f2092a.contract.locked.json`.
 *
...
// promoted.
const BM155_REQUIRED_FIELD_PATHS = [] as const;

export const BM155_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-155",
  title: "Biểu mẫu BM-155",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM155_FIELD_PATHS,
  requiredFieldPaths: BM155_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-155 anchors must
...
registerFormFlightProfile(BM155_FORM_FLIGHT_PROFILE);
