 ...
 * contract `docs\audit\docx\contracts\locked\BM-102__88bde5060df8.contract.locked.json`.
 *
...
// promoted.
const BM102_REQUIRED_FIELD_PATHS = [] as const;

export const BM102_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-102",
  title: "Biểu mẫu BM-102",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM102_FIELD_PATHS,
  requiredFieldPaths: BM102_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-102 anchors must
...
registerFormFlightProfile(BM102_FORM_FLIGHT_PROFILE);
