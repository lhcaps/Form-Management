 ...
 * contract `docs\audit\docx\contracts\locked\BM-092__f8ca4bc8033d.contract.locked.json`.
 *
...
// promoted.
const BM092_REQUIRED_FIELD_PATHS = [] as const;

export const BM092_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-092",
  title: "Biểu mẫu BM-092",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM092_FIELD_PATHS,
  requiredFieldPaths: BM092_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-092 anchors must
...
registerFormFlightProfile(BM092_FORM_FLIGHT_PROFILE);
