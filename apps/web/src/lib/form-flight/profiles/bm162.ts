 ...
 * contract `docs\audit\docx\contracts\locked\BM-162__6e7e16348066.contract.locked.json`.
 *
...
// promoted.
const BM162_REQUIRED_FIELD_PATHS = [] as const;

export const BM162_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-162",
  title: "Biểu mẫu BM-162",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM162_FIELD_PATHS,
  requiredFieldPaths: BM162_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-162 anchors must
...
registerFormFlightProfile(BM162_FORM_FLIGHT_PROFILE);
