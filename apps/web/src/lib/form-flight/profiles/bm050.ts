 ...
 * contract `docs\audit\docx\contracts\locked\BM-050__2d31c941887e.contract.locked.json`.
 *
...
// promoted.
const BM050_REQUIRED_FIELD_PATHS = [] as const;

export const BM050_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-050",
  title: "Biểu mẫu BM-050",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM050_FIELD_PATHS,
  requiredFieldPaths: BM050_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-050 anchors must
...
registerFormFlightProfile(BM050_FORM_FLIGHT_PROFILE);
