 ...
 * contract `docs\audit\docx\contracts\locked\BM-031__ec3276d1eebe.contract.locked.json`.
 *
...
// promoted.
const BM031_REQUIRED_FIELD_PATHS = [] as const;

export const BM031_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-031",
  title: "Biểu mẫu BM-031",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM031_FIELD_PATHS,
  requiredFieldPaths: BM031_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-031 anchors must
...
registerFormFlightProfile(BM031_FORM_FLIGHT_PROFILE);
