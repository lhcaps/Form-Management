 ...
 * contract `docs\audit\docx\contracts\locked\BM-066__e3bc56081554.contract.locked.json`.
 *
...
// promoted.
const BM066_REQUIRED_FIELD_PATHS = [] as const;

export const BM066_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-066",
  title: "Biểu mẫu BM-066",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM066_FIELD_PATHS,
  requiredFieldPaths: BM066_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-066 anchors must
...
registerFormFlightProfile(BM066_FORM_FLIGHT_PROFILE);
