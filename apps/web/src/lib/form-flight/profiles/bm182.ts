 ...
 * contract `docs\audit\docx\contracts\locked\BM-182__95dc6d1f57ab.contract.locked.json`.
 *
...
// promoted.
const BM182_REQUIRED_FIELD_PATHS = [] as const;

export const BM182_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-182",
  title: "Biểu mẫu BM-182",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM182_FIELD_PATHS,
  requiredFieldPaths: BM182_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-182 anchors must
...
registerFormFlightProfile(BM182_FORM_FLIGHT_PROFILE);
