 ...
 * contract `docs\audit\docx\contracts\locked\BM-149__3990ac4442f1.contract.locked.json`.
 *
...
// promoted.
const BM149_REQUIRED_FIELD_PATHS = [] as const;

export const BM149_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-149",
  title: "Biểu mẫu BM-149",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM149_FIELD_PATHS,
  requiredFieldPaths: BM149_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-149 anchors must
...
registerFormFlightProfile(BM149_FORM_FLIGHT_PROFILE);
