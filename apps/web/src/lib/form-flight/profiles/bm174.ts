 ...
 * contract `docs\audit\docx\contracts\locked\BM-174__f8e45c638bb6.contract.locked.json`.
 *
...
// promoted.
const BM174_REQUIRED_FIELD_PATHS = [] as const;

export const BM174_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-174",
  title: "Biểu mẫu BM-174",
  ...
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-174 anchors must
