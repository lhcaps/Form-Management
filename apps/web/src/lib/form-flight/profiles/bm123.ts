 ...
 * contract `docs\audit\docx\contracts\locked\BM-123__8aa275f0ac70.contract.locked.json`.
 *
...
// promoted.
const BM123_REQUIRED_FIELD_PATHS = [] as const;

export const BM123_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-123",
  title: "Biểu mẫu BM-123",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM123_FIELD_PATHS,
  requiredFieldPaths: BM123_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-123 anchors must
...
registerFormFlightProfile(BM123_FORM_FLIGHT_PROFILE);
