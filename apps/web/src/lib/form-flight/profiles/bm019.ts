 ...
 * contract `docs\audit\docx\contracts\locked\BM-019__3c2858f47dad.contract.locked.json`.
 *
...
// promoted.
const BM019_REQUIRED_FIELD_PATHS = [] as const;

export const BM019_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-019",
  title: "Biểu mẫu BM-019",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM019_FIELD_PATHS,
  requiredFieldPaths: BM019_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-019 anchors must
...
registerFormFlightProfile(BM019_FORM_FLIGHT_PROFILE);
