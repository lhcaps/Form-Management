 ...
 * contract `docs\audit\docx\contracts\locked\BM-087__80e8edb6b8b2.contract.locked.json`.
 *
...
// promoted.
const BM087_REQUIRED_FIELD_PATHS = [] as const;

export const BM087_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-087",
  title: "Biểu mẫu BM-087",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM087_FIELD_PATHS,
  requiredFieldPaths: BM087_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-087 anchors must
...
registerFormFlightProfile(BM087_FORM_FLIGHT_PROFILE);
