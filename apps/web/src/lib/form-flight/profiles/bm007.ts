 ...
 * contract `docs\audit\docx\contracts\locked\BM-007__549970d471d1.contract.locked.json`.
 *
...
// promoted.
const BM007_REQUIRED_FIELD_PATHS = [] as const;

export const BM007_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-007",
  title: "Biểu mẫu BM-007",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM007_FIELD_PATHS,
  requiredFieldPaths: BM007_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-007 anchors must
...
registerFormFlightProfile(BM007_FORM_FLIGHT_PROFILE);
