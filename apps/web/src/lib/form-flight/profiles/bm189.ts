 ...
 * contract `docs\audit\docx\contracts\locked\BM-189__70da8df0a0da.contract.locked.json`.
 *
...
// promoted.
const BM189_REQUIRED_FIELD_PATHS = [] as const;

export const BM189_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-189",
  title: "Biểu mẫu BM-189",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM189_FIELD_PATHS,
  requiredFieldPaths: BM189_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-189 anchors must
...
registerFormFlightProfile(BM189_FORM_FLIGHT_PROFILE);
