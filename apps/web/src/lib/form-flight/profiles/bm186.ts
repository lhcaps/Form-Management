 ...
 * contract `docs\audit\docx\contracts\locked\BM-186__84cb2023273b.contract.locked.json`.
 *
...
// promoted.
const BM186_REQUIRED_FIELD_PATHS = [] as const;

export const BM186_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-186",
  title: "Biểu mẫu BM-186",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM186_FIELD_PATHS,
  requiredFieldPaths: BM186_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-186 anchors must
...
registerFormFlightProfile(BM186_FORM_FLIGHT_PROFILE);
