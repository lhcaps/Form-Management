 ...
 * contract `docs\audit\docx\contracts\locked\BM-198__269efb9590af.contract.locked.json`.
 *
...
// promoted.
const BM198_REQUIRED_FIELD_PATHS = [] as const;

export const BM198_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-198",
  title: "Biểu mẫu BM-198",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM198_FIELD_PATHS,
  requiredFieldPaths: BM198_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-198 anchors must
...
registerFormFlightProfile(BM198_FORM_FLIGHT_PROFILE);
