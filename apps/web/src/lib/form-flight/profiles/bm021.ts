 ...
 * contract `docs\audit\docx\contracts\locked\BM-021__772319486f41.contract.locked.json`.
 *
...
// promoted.
const BM021_REQUIRED_FIELD_PATHS = [] as const;

export const BM021_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-021",
  title: "Biểu mẫu BM-021",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM021_FIELD_PATHS,
  requiredFieldPaths: BM021_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-021 anchors must
...
registerFormFlightProfile(BM021_FORM_FLIGHT_PROFILE);
