 ...
 * contract `docs\audit\docx\contracts\locked\BM-109__0fe502079a3e.contract.locked.json`.
 *
...
// promoted.
const BM109_REQUIRED_FIELD_PATHS = [] as const;

export const BM109_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-109",
  title: "Biểu mẫu BM-109",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM109_FIELD_PATHS,
  requiredFieldPaths: BM109_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-109 anchors must
...
registerFormFlightProfile(BM109_FORM_FLIGHT_PROFILE);
