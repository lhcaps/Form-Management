 ...
 * contract `docs\audit\docx\contracts\locked\BM-150__d19a8665087c.contract.locked.json`.
 *
...
// promoted.
const BM150_REQUIRED_FIELD_PATHS = [] as const;

export const BM150_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-150",
  title: "Biểu mẫu BM-150",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM150_FIELD_PATHS,
  requiredFieldPaths: BM150_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-150 anchors must
...
registerFormFlightProfile(BM150_FORM_FLIGHT_PROFILE);
