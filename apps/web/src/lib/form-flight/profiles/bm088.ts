 ...
 * contract `docs\audit\docx\contracts\locked\BM-088__d9d213d94690.contract.locked.json`.
 *
...
// promoted.
const BM088_REQUIRED_FIELD_PATHS = [] as const;

export const BM088_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-088",
  title: "Biểu mẫu BM-088",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM088_FIELD_PATHS,
  requiredFieldPaths: BM088_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-088 anchors must
...
registerFormFlightProfile(BM088_FORM_FLIGHT_PROFILE);
