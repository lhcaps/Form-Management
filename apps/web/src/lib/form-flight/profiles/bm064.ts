 ...
 * contract `docs\audit\docx\contracts\locked\BM-064__4d8cebc3515b.contract.locked.json`.
 *
...
// promoted.
const BM064_REQUIRED_FIELD_PATHS = [] as const;

export const BM064_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-064",
  title: "Biểu mẫu BM-064",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM064_FIELD_PATHS,
  requiredFieldPaths: BM064_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-064 anchors must
...
registerFormFlightProfile(BM064_FORM_FLIGHT_PROFILE);
