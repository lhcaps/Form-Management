 ...
 * contract `docs\audit\docx\contracts\locked\BM-165__d391dc4d1ffb.contract.locked.json`.
 *
...
// promoted.
const BM165_REQUIRED_FIELD_PATHS = [] as const;

export const BM165_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-165",
  title: "Biểu mẫu BM-165",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM165_FIELD_PATHS,
  requiredFieldPaths: BM165_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-165 anchors must
...
registerFormFlightProfile(BM165_FORM_FLIGHT_PROFILE);
