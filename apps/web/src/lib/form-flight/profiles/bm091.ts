 ...
 * contract `docs\audit\docx\contracts\locked\BM-091__18a41431ecae.contract.locked.json`.
 *
...
// promoted.
const BM091_REQUIRED_FIELD_PATHS = [] as const;

export const BM091_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-091",
  title: "Biểu mẫu BM-091",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM091_FIELD_PATHS,
  requiredFieldPaths: BM091_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-091 anchors must
...
registerFormFlightProfile(BM091_FORM_FLIGHT_PROFILE);
