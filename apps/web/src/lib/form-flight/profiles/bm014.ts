 ...
 * contract `docs\audit\docx\contracts\locked\BM-014__ff318bb91779.contract.locked.json`.
 *
...
// promoted.
const BM014_REQUIRED_FIELD_PATHS = [] as const;

export const BM014_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-014",
  title: "Biểu mẫu BM-014",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM014_FIELD_PATHS,
  requiredFieldPaths: BM014_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-014 anchors must
...
registerFormFlightProfile(BM014_FORM_FLIGHT_PROFILE);
