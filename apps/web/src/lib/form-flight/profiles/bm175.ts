 ...
 * contract `docs\audit\docx\contracts\locked\BM-175__6d3f2b46283d.contract.locked.json`.
 *
...
// promoted.
const BM175_REQUIRED_FIELD_PATHS = [] as const;

export const BM175_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-175",
  title: "Biểu mẫu BM-175",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM175_FIELD_PATHS,
  requiredFieldPaths: BM175_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-175 anchors must
...
registerFormFlightProfile(BM175_FORM_FLIGHT_PROFILE);
