 ...
 * contract `docs\audit\docx\contracts\locked\BM-202__0c74f6ae9727.contract.locked.json`.
 *
...
// promoted.
const BM202_REQUIRED_FIELD_PATHS = [] as const;

export const BM202_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-202",
  title: "Biểu mẫu BM-202",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM202_FIELD_PATHS,
  requiredFieldPaths: BM202_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-202 anchors must
...
registerFormFlightProfile(BM202_FORM_FLIGHT_PROFILE);
