 ...
 * contract `docs\audit\docx\contracts\locked\BM-004__2775520fd22c.contract.locked.json`.
 *
...
// promoted.
const BM004_REQUIRED_FIELD_PATHS = [] as const;

export const BM004_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-004",
  title: "Biểu mẫu BM-004",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM004_FIELD_PATHS,
  requiredFieldPaths: BM004_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-004 anchors must
...
registerFormFlightProfile(BM004_FORM_FLIGHT_PROFILE);
