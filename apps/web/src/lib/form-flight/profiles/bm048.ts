 ...
 * contract `docs\audit\docx\contracts\locked\BM-048__724a5a8b3421.contract.locked.json`.
 *
...
// promoted.
const BM048_REQUIRED_FIELD_PATHS = [] as const;

export const BM048_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-048",
  title: "Biểu mẫu BM-048",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM048_FIELD_PATHS,
  requiredFieldPaths: BM048_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-048 anchors must
...
registerFormFlightProfile(BM048_FORM_FLIGHT_PROFILE);
