 ...
 * contract `docs\audit\docx\contracts\locked\BM-072__fadb53cde2cb.contract.locked.json`.
 *
...
// promoted.
const BM072_REQUIRED_FIELD_PATHS = [] as const;

export const BM072_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-072",
  title: "Biểu mẫu BM-072",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM072_FIELD_PATHS,
  requiredFieldPaths: BM072_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-072 anchors must
...
registerFormFlightProfile(BM072_FORM_FLIGHT_PROFILE);
