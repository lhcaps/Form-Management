 ...
 * contract `docs\audit\docx\contracts\locked\BM-062__110961a781fa.contract.locked.json`.
 *
...
// promoted.
const BM062_REQUIRED_FIELD_PATHS = [] as const;

export const BM062_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-062",
  title: "Biểu mẫu BM-062",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM062_FIELD_PATHS,
  requiredFieldPaths: BM062_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-062 anchors must
...
registerFormFlightProfile(BM062_FORM_FLIGHT_PROFILE);
