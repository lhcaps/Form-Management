 ...
 * contract `docs\audit\docx\contracts\locked\BM-080__a7aa64d4b889.contract.locked.json`.
 *
...
// promoted.
const BM080_REQUIRED_FIELD_PATHS = [] as const;

export const BM080_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-080",
  title: "Biểu mẫu BM-080",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM080_FIELD_PATHS,
  requiredFieldPaths: BM080_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-080 anchors must
...
registerFormFlightProfile(BM080_FORM_FLIGHT_PROFILE);
