 ...
 * contract `docs\audit\docx\contracts\locked\BM-146__59e5d7e21119.contract.locked.json`.
 *
...
// promoted.
const BM146_REQUIRED_FIELD_PATHS = [] as const;

export const BM146_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-146",
  title: "Biểu mẫu BM-146",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM146_FIELD_PATHS,
  requiredFieldPaths: BM146_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-146 anchors must
...
registerFormFlightProfile(BM146_FORM_FLIGHT_PROFILE);
