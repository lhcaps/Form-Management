 ...
 * contract `docs\audit\docx\contracts\locked\BM-131__91726e55d979.contract.locked.json`.
 *
...
// promoted.
const BM131_REQUIRED_FIELD_PATHS = [] as const;

export const BM131_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-131",
  title: "Biểu mẫu BM-131",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM131_FIELD_PATHS,
  requiredFieldPaths: BM131_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-131 anchors must
...
registerFormFlightProfile(BM131_FORM_FLIGHT_PROFILE);
