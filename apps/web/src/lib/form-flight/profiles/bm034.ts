 ...
 * contract `docs\audit\docx\contracts\locked\BM-034__e02f842b6038.contract.locked.json`.
 *
...
// promoted.
const BM034_REQUIRED_FIELD_PATHS = [] as const;

export const BM034_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-034",
  title: "Biểu mẫu BM-034",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM034_FIELD_PATHS,
  requiredFieldPaths: BM034_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-034 anchors must
...
registerFormFlightProfile(BM034_FORM_FLIGHT_PROFILE);
