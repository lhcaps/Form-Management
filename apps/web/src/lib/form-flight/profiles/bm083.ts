 ...
 * contract `docs\audit\docx\contracts\locked\BM-083__71218955a7c2.contract.locked.json`.
 *
...
// promoted.
const BM083_REQUIRED_FIELD_PATHS = [] as const;

export const BM083_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-083",
  title: "Biểu mẫu BM-083",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM083_FIELD_PATHS,
  requiredFieldPaths: BM083_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-083 anchors must
...
registerFormFlightProfile(BM083_FORM_FLIGHT_PROFILE);
