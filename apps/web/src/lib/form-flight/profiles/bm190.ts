 ...
 * contract `docs\audit\docx\contracts\locked\BM-190__36fb96ee1a73.contract.locked.json`.
 *
...
// promoted.
const BM190_REQUIRED_FIELD_PATHS = [] as const;

export const BM190_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-190",
  title: "Biểu mẫu BM-190",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM190_FIELD_PATHS,
  requiredFieldPaths: BM190_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-190 anchors must
...
registerFormFlightProfile(BM190_FORM_FLIGHT_PROFILE);
