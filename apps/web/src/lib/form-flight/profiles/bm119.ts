 ...
 * contract `docs\audit\docx\contracts\locked\BM-119__bb054433cbac.contract.locked.json`.
 *
...
// promoted.
const BM119_REQUIRED_FIELD_PATHS = [] as const;

export const BM119_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-119",
  title: "Biểu mẫu BM-119",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM119_FIELD_PATHS,
  requiredFieldPaths: BM119_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-119 anchors must
...
registerFormFlightProfile(BM119_FORM_FLIGHT_PROFILE);
