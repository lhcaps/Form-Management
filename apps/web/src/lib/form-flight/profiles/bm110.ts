 ...
 * contract `docs\audit\docx\contracts\locked\BM-110__a1f991fed29c.contract.locked.json`.
 *
...
// promoted.
const BM110_REQUIRED_FIELD_PATHS = [] as const;

export const BM110_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-110",
  title: "Biểu mẫu BM-110",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM110_FIELD_PATHS,
  requiredFieldPaths: BM110_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-110 anchors must
...
registerFormFlightProfile(BM110_FORM_FLIGHT_PROFILE);
