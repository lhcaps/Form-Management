 ...
 * contract `docs\audit\docx\contracts\locked\BM-160__2f8e7c014448.contract.locked.json`.
 *
...
// promoted.
const BM160_REQUIRED_FIELD_PATHS = [] as const;

export const BM160_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-160",
  title: "Biểu mẫu BM-160",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM160_FIELD_PATHS,
  requiredFieldPaths: BM160_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-160 anchors must
...
registerFormFlightProfile(BM160_FORM_FLIGHT_PROFILE);
