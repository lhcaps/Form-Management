 ...
 * contract `docs\audit\docx\contracts\locked\BM-045__13efe0d94756.contract.locked.json`.
 *
...
// promoted.
const BM045_REQUIRED_FIELD_PATHS = [] as const;

export const BM045_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-045",
  title: "Biểu mẫu BM-045",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM045_FIELD_PATHS,
  requiredFieldPaths: BM045_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-045 anchors must
...
registerFormFlightProfile(BM045_FORM_FLIGHT_PROFILE);
