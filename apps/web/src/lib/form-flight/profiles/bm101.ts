 ...
 * contract `docs\audit\docx\contracts\locked\BM-101__2fe2187f4777.contract.locked.json`.
 *
...
// promoted.
const BM101_REQUIRED_FIELD_PATHS = [] as const;

export const BM101_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-101",
  title: "Biểu mẫu BM-101",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM101_FIELD_PATHS,
  requiredFieldPaths: BM101_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-101 anchors must
...
registerFormFlightProfile(BM101_FORM_FLIGHT_PROFILE);
