 ...
 * contract `docs\audit\docx\contracts\locked\BM-180__d608f62a685a.contract.locked.json`.
 *
...
// promoted.
const BM180_REQUIRED_FIELD_PATHS = [] as const;

export const BM180_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-180",
  title: "Biểu mẫu BM-180",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM180_FIELD_PATHS,
  requiredFieldPaths: BM180_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-180 anchors must
...
registerFormFlightProfile(BM180_FORM_FLIGHT_PROFILE);
