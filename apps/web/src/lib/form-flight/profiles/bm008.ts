 ...
 * contract `docs\audit\docx\contracts\locked\BM-008__87981f1c5cf8.contract.locked.json`.
 *
...
// promoted.
const BM008_REQUIRED_FIELD_PATHS = [] as const;

export const BM008_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-008",
  title: "Biểu mẫu BM-008",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM008_FIELD_PATHS,
  requiredFieldPaths: BM008_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-008 anchors must
...
registerFormFlightProfile(BM008_FORM_FLIGHT_PROFILE);
