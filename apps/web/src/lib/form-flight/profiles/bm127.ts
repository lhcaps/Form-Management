 ...
 * contract `docs\audit\docx\contracts\locked\BM-127__582febaeadf0.contract.locked.json`.
 *
...
// promoted.
const BM127_REQUIRED_FIELD_PATHS = [] as const;

export const BM127_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-127",
  title: "Biểu mẫu BM-127",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM127_FIELD_PATHS,
  requiredFieldPaths: BM127_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-127 anchors must
...
registerFormFlightProfile(BM127_FORM_FLIGHT_PROFILE);
