 ...
 * contract `docs\audit\docx\contracts\locked\BM-185__69c976088827.contract.locked.json`.
 *
...
// promoted.
const BM185_REQUIRED_FIELD_PATHS = [] as const;

export const BM185_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-185",
  title: "Biểu mẫu BM-185",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM185_FIELD_PATHS,
  requiredFieldPaths: BM185_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-185 anchors must
...
registerFormFlightProfile(BM185_FORM_FLIGHT_PROFILE);
