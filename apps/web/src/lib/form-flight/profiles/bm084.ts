 ...
 * contract `docs\audit\docx\contracts\locked\BM-084__c21e2b7fa5cc.contract.locked.json`.
 *
...
// promoted.
const BM084_REQUIRED_FIELD_PATHS = [] as const;

export const BM084_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-084",
  title: "Biểu mẫu BM-084",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM084_FIELD_PATHS,
  requiredFieldPaths: BM084_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-084 anchors must
...
registerFormFlightProfile(BM084_FORM_FLIGHT_PROFILE);
