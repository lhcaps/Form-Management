 ...
 * contract `docs\audit\docx\contracts\locked\BM-081__232b8c1d66ae.contract.locked.json`.
 *
...
// promoted.
const BM081_REQUIRED_FIELD_PATHS = [] as const;

export const BM081_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-081",
  title: "Biểu mẫu BM-081",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM081_FIELD_PATHS,
  requiredFieldPaths: BM081_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-081 anchors must
...
registerFormFlightProfile(BM081_FORM_FLIGHT_PROFILE);
