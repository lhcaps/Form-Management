 ...
 * contract `docs\audit\docx\contracts\locked\BM-147__7bf9bc811cad.contract.locked.json`.
 *
...
// promoted.
const BM147_REQUIRED_FIELD_PATHS = [] as const;

export const BM147_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-147",
  title: "Biểu mẫu BM-147",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM147_FIELD_PATHS,
  requiredFieldPaths: BM147_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-147 anchors must
...
registerFormFlightProfile(BM147_FORM_FLIGHT_PROFILE);
