 ...
 * contract `docs\audit\docx\contracts\locked\BM-086__df834c030dc6.contract.locked.json`.
 *
...
// promoted.
const BM086_REQUIRED_FIELD_PATHS = [] as const;

export const BM086_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-086",
  title: "Biểu mẫu BM-086",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM086_FIELD_PATHS,
  requiredFieldPaths: BM086_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-086 anchors must
...
registerFormFlightProfile(BM086_FORM_FLIGHT_PROFILE);
