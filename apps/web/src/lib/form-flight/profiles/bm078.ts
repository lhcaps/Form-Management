 ...
 * contract `docs\audit\docx\contracts\locked\BM-078__6845bd7e6cb1.contract.locked.json`.
 *
...
// promoted.
const BM078_REQUIRED_FIELD_PATHS = [] as const;

export const BM078_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-078",
  title: "Biểu mẫu BM-078",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM078_FIELD_PATHS,
  requiredFieldPaths: BM078_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-078 anchors must
...
registerFormFlightProfile(BM078_FORM_FLIGHT_PROFILE);
