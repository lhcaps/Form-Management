 ...
 * contract `docs\audit\docx\contracts\locked\BM-005__4cf240724a90.contract.locked.json`.
 *
...
// promoted.
const BM005_REQUIRED_FIELD_PATHS = [] as const;

export const BM005_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-005",
  title: "Biểu mẫu BM-005",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM005_FIELD_PATHS,
  requiredFieldPaths: BM005_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-005 anchors must
...
registerFormFlightProfile(BM005_FORM_FLIGHT_PROFILE);
