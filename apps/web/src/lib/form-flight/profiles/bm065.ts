 ...
 * contract `docs\audit\docx\contracts\locked\BM-065__4a64c8d7e96c.contract.locked.json`.
 *
...
// promoted.
const BM065_REQUIRED_FIELD_PATHS = [] as const;

export const BM065_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-065",
  title: "Biểu mẫu BM-065",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM065_FIELD_PATHS,
  requiredFieldPaths: BM065_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-065 anchors must
...
registerFormFlightProfile(BM065_FORM_FLIGHT_PROFILE);
