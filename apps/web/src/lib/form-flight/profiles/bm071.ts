 ...
 * contract `docs\audit\docx\contracts\locked\BM-071__cacf3f480888.contract.locked.json`.
 *
...
// promoted.
const BM071_REQUIRED_FIELD_PATHS = [] as const;

export const BM071_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-071",
  title: "Biểu mẫu BM-071",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM071_FIELD_PATHS,
  requiredFieldPaths: BM071_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-071 anchors must
...
registerFormFlightProfile(BM071_FORM_FLIGHT_PROFILE);
