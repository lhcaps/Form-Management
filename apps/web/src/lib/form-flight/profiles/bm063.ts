 ...
 * contract `docs\audit\docx\contracts\locked\BM-063__54b73110a34f.contract.locked.json`.
 *
...
// promoted.
const BM063_REQUIRED_FIELD_PATHS = [] as const;

export const BM063_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-063",
  title: "Biểu mẫu BM-063",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM063_FIELD_PATHS,
  requiredFieldPaths: BM063_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-063 anchors must
...
registerFormFlightProfile(BM063_FORM_FLIGHT_PROFILE);
