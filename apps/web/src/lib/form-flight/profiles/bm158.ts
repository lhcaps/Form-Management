 ...
 * contract `docs\audit\docx\contracts\locked\BM-158__7a98055a3e9c.contract.locked.json`.
 *
...
// promoted.
const BM158_REQUIRED_FIELD_PATHS = [] as const;

export const BM158_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-158",
  title: "Biểu mẫu BM-158",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM158_FIELD_PATHS,
  requiredFieldPaths: BM158_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-158 anchors must
...
registerFormFlightProfile(BM158_FORM_FLIGHT_PROFILE);
