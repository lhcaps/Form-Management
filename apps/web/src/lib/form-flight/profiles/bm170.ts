 ...
 * contract `docs\audit\docx\contracts\locked\BM-170__c8f50b0e9f5b.contract.locked.json`.
 *
...
// promoted.
const BM170_REQUIRED_FIELD_PATHS = [] as const;

export const BM170_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-170",
  title: "Biểu mẫu BM-170",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM170_FIELD_PATHS,
  requiredFieldPaths: BM170_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-170 anchors must
...
registerFormFlightProfile(BM170_FORM_FLIGHT_PROFILE);
