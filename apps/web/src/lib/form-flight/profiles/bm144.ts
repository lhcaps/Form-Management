 ...
 * contract `docs\audit\docx\contracts\locked\BM-144__720233712d47.contract.locked.json`.
 *
...
// promoted.
const BM144_REQUIRED_FIELD_PATHS = [] as const;

export const BM144_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-144",
  title: "Biểu mẫu BM-144",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM144_FIELD_PATHS,
  requiredFieldPaths: BM144_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-144 anchors must
...
registerFormFlightProfile(BM144_FORM_FLIGHT_PROFILE);
