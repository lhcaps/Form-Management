 ...
 * contract `docs\audit\docx\contracts\locked\BM-037__1fa31d43251e.contract.locked.json`.
 *
...
// promoted.
const BM037_REQUIRED_FIELD_PATHS = [] as const;

export const BM037_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-037",
  title: "Biểu mẫu BM-037",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM037_FIELD_PATHS,
  requiredFieldPaths: BM037_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-037 anchors must
...
registerFormFlightProfile(BM037_FORM_FLIGHT_PROFILE);
