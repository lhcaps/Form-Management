 ...
 * contract `docs\audit\docx\contracts\locked\BM-135__79b31ad7511e.contract.locked.json`.
 *
...
// promoted.
const BM135_REQUIRED_FIELD_PATHS = [] as const;

export const BM135_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-135",
  title: "Biểu mẫu BM-135",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM135_FIELD_PATHS,
  requiredFieldPaths: BM135_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-135 anchors must
...
registerFormFlightProfile(BM135_FORM_FLIGHT_PROFILE);
