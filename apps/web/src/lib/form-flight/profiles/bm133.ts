 ...
 * contract `docs\audit\docx\contracts\locked\BM-133__1f7f12f1a249.contract.locked.json`.
 *
...
// promoted.
const BM133_REQUIRED_FIELD_PATHS = [] as const;

export const BM133_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-133",
  title: "Biểu mẫu BM-133",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM133_FIELD_PATHS,
  requiredFieldPaths: BM133_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-133 anchors must
...
registerFormFlightProfile(BM133_FORM_FLIGHT_PROFILE);
