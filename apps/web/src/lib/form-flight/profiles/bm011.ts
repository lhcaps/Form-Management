 ...
 * contract `docs\audit\docx\contracts\locked\BM-011__26e6e688d223.contract.locked.json`.
 *
...
// promoted.
const BM011_REQUIRED_FIELD_PATHS = [] as const;

export const BM011_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-011",
  title: "Biểu mẫu BM-011",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM011_FIELD_PATHS,
  requiredFieldPaths: BM011_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-011 anchors must
...
registerFormFlightProfile(BM011_FORM_FLIGHT_PROFILE);
