 ...
 * contract `docs\audit\docx\contracts\locked\BM-104__6d6f5903cad3.contract.locked.json`.
 *
...
// promoted.
const BM104_REQUIRED_FIELD_PATHS = [] as const;

export const BM104_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-104",
  title: "Biểu mẫu BM-104",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM104_FIELD_PATHS,
  requiredFieldPaths: BM104_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-104 anchors must
...
registerFormFlightProfile(BM104_FORM_FLIGHT_PROFILE);
