 ...
 * contract `docs\audit\docx\contracts\locked\BM-129__7fb66a442c28.contract.locked.json`.
 *
...
// promoted.
const BM129_REQUIRED_FIELD_PATHS = [] as const;

export const BM129_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-129",
  title: "Biểu mẫu BM-129",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM129_FIELD_PATHS,
  requiredFieldPaths: BM129_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-129 anchors must
...
registerFormFlightProfile(BM129_FORM_FLIGHT_PROFILE);
