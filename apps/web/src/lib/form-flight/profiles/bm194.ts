 ...
 * contract `docs\audit\docx\contracts\locked\BM-194__946009a4f0e0.contract.locked.json`.
 *
...
// promoted.
const BM194_REQUIRED_FIELD_PATHS = [] as const;

export const BM194_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-194",
  title: "Biểu mẫu BM-194",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM194_FIELD_PATHS,
  requiredFieldPaths: BM194_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-194 anchors must
...
registerFormFlightProfile(BM194_FORM_FLIGHT_PROFILE);
