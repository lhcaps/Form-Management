 ...
 * contract `docs\audit\docx\contracts\locked\BM-060__55a252b4f98f.contract.locked.json`.
 *
...
// promoted.
const BM060_REQUIRED_FIELD_PATHS = [] as const;

export const BM060_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-060",
  title: "Biểu mẫu BM-060",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM060_FIELD_PATHS,
  requiredFieldPaths: BM060_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-060 anchors must
...
registerFormFlightProfile(BM060_FORM_FLIGHT_PROFILE);
