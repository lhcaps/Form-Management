 ...
 * contract `docs\audit\docx\contracts\locked\BM-153__829ed04c824a.contract.locked.json`.
 *
...
// promoted.
const BM153_REQUIRED_FIELD_PATHS = [] as const;

export const BM153_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-153",
  title: "Biểu mẫu BM-153",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM153_FIELD_PATHS,
  requiredFieldPaths: BM153_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-153 anchors must
...
registerFormFlightProfile(BM153_FORM_FLIGHT_PROFILE);
