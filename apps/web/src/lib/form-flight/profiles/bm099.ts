 ...
 * contract `docs\audit\docx\contracts\locked\BM-099__ce4aa505a071.contract.locked.json`.
 *
...
// promoted.
const BM099_REQUIRED_FIELD_PATHS = [] as const;

export const BM099_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-099",
  title: "Biểu mẫu BM-099",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM099_FIELD_PATHS,
  requiredFieldPaths: BM099_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-099 anchors must
...
registerFormFlightProfile(BM099_FORM_FLIGHT_PROFILE);
