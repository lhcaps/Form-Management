 ...
 * contract `docs\audit\docx\contracts\locked\BM-201__2d0aab05928d.contract.locked.json`.
 *
...
// promoted.
const BM201_REQUIRED_FIELD_PATHS = [] as const;

export const BM201_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-201",
  title: "Biểu mẫu BM-201",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM201_FIELD_PATHS,
  requiredFieldPaths: BM201_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-201 anchors must
...
registerFormFlightProfile(BM201_FORM_FLIGHT_PROFILE);
