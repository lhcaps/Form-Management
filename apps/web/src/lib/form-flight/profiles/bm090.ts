 ...
 * contract `docs\audit\docx\contracts\locked\BM-090__1c7858168558.contract.locked.json`.
 *
...
// promoted.
const BM090_REQUIRED_FIELD_PATHS = [] as const;

export const BM090_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-090",
  title: "Biểu mẫu BM-090",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM090_FIELD_PATHS,
  requiredFieldPaths: BM090_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-090 anchors must
...
registerFormFlightProfile(BM090_FORM_FLIGHT_PROFILE);
