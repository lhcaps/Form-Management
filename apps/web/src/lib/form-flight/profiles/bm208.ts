 ...
 * contract `docs\audit\docx\contracts\locked\BM-208__93ee4a40d673.contract.locked.json`.
 *
...
// promoted.
const BM208_REQUIRED_FIELD_PATHS = [] as const;

export const BM208_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-208",
  title: "Biểu mẫu BM-208",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM208_FIELD_PATHS,
  requiredFieldPaths: BM208_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-208 anchors must
...
registerFormFlightProfile(BM208_FORM_FLIGHT_PROFILE);
