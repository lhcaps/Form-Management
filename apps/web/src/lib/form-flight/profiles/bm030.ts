 ...
 * contract `docs\audit\docx\contracts\locked\BM-030__0cfa7ae4b177.contract.locked.json`.
 *
...
// promoted.
const BM030_REQUIRED_FIELD_PATHS = [] as const;

export const BM030_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-030",
  title: "Biểu mẫu BM-030",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM030_FIELD_PATHS,
  requiredFieldPaths: BM030_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-030 anchors must
...
registerFormFlightProfile(BM030_FORM_FLIGHT_PROFILE);
