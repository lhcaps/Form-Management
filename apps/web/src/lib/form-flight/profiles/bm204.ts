 ...
 * contract `docs\audit\docx\contracts\locked\BM-204__f334b93daabe.contract.locked.json`.
 *
...
// promoted.
const BM204_REQUIRED_FIELD_PATHS = [] as const;

export const BM204_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-204",
  title: "Biểu mẫu BM-204",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM204_FIELD_PATHS,
  requiredFieldPaths: BM204_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-204 anchors must
...
registerFormFlightProfile(BM204_FORM_FLIGHT_PROFILE);
