 ...
 * contract `docs\audit\docx\contracts\locked\BM-067__0f7607122f29.contract.locked.json`.
 *
...
// promoted.
const BM067_REQUIRED_FIELD_PATHS = [] as const;

export const BM067_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-067",
  title: "Biểu mẫu BM-067",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM067_FIELD_PATHS,
  requiredFieldPaths: BM067_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-067 anchors must
...
registerFormFlightProfile(BM067_FORM_FLIGHT_PROFILE);
