 ...
 * contract `docs\audit\docx\contracts\locked\BM-187__e47644149068.contract.locked.json`.
 *
...
// promoted.
const BM187_REQUIRED_FIELD_PATHS = [] as const;

export const BM187_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-187",
  title: "Biểu mẫu BM-187",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM187_FIELD_PATHS,
  requiredFieldPaths: BM187_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-187 anchors must
...
registerFormFlightProfile(BM187_FORM_FLIGHT_PROFILE);
