 ...
 * contract `docs\audit\docx\contracts\locked\BM-013__9a1f7d37fec9.contract.locked.json`.
 *
...
// promoted.
const BM013_REQUIRED_FIELD_PATHS = [] as const;

export const BM013_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-013",
  title: "Biểu mẫu BM-013",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM013_FIELD_PATHS,
  requiredFieldPaths: BM013_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-013 anchors must
...
registerFormFlightProfile(BM013_FORM_FLIGHT_PROFILE);
