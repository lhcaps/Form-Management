 ...
 * contract `docs\audit\docx\contracts\locked\BM-122__c6efcf63e36a.contract.locked.json`.
 *
...
// promoted.
const BM122_REQUIRED_FIELD_PATHS = [] as const;

export const BM122_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-122",
  title: "Biểu mẫu BM-122",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM122_FIELD_PATHS,
  requiredFieldPaths: BM122_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-122 anchors must
...
registerFormFlightProfile(BM122_FORM_FLIGHT_PROFILE);
