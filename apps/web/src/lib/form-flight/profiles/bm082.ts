 ...
 * contract `docs\audit\docx\contracts\locked\BM-082__44cc2b043383.contract.locked.json`.
 *
...
// promoted.
const BM082_REQUIRED_FIELD_PATHS = [] as const;

export const BM082_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-082",
  title: "Biểu mẫu BM-082",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM082_FIELD_PATHS,
  requiredFieldPaths: BM082_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-082 anchors must
...
registerFormFlightProfile(BM082_FORM_FLIGHT_PROFILE);
