 ...
 * contract `docs\audit\docx\contracts\locked\BM-183__294fc847169f.contract.locked.json`.
 *
...
// promoted.
const BM183_REQUIRED_FIELD_PATHS = [] as const;

export const BM183_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-183",
  title: "Biểu mẫu BM-183",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM183_FIELD_PATHS,
  requiredFieldPaths: BM183_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-183 anchors must
...
registerFormFlightProfile(BM183_FORM_FLIGHT_PROFILE);
