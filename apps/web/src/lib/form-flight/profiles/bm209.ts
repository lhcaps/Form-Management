 ...
 * contract `docs\audit\docx\contracts\locked\BM-209__2547ef797798.contract.locked.json`.
 *
...
// promoted.
const BM209_REQUIRED_FIELD_PATHS = [] as const;

export const BM209_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-209",
  title: "Biểu mẫu BM-209",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM209_FIELD_PATHS,
  requiredFieldPaths: BM209_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-209 anchors must
...
registerFormFlightProfile(BM209_FORM_FLIGHT_PROFILE);
