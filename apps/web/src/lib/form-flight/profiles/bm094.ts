 ...
 * contract `docs\audit\docx\contracts\locked\BM-094__12ad016b36d2.contract.locked.json`.
 *
...
// promoted.
const BM094_REQUIRED_FIELD_PATHS = [] as const;

export const BM094_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-094",
  title: "Biểu mẫu BM-094",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM094_FIELD_PATHS,
  requiredFieldPaths: BM094_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-094 anchors must
...
registerFormFlightProfile(BM094_FORM_FLIGHT_PROFILE);
