 ...
 * contract `docs\audit\docx\contracts\locked\BM-097__17f981bf5afd.contract.locked.json`.
 *
...
// promoted.
const BM097_REQUIRED_FIELD_PATHS = [] as const;

export const BM097_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-097",
  title: "Biểu mẫu BM-097",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM097_FIELD_PATHS,
  requiredFieldPaths: BM097_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-097 anchors must
...
registerFormFlightProfile(BM097_FORM_FLIGHT_PROFILE);
