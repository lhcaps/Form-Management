 ...
 * contract `docs\audit\docx\contracts\locked\BM-152__d28f03a3f72b.contract.locked.json`.
 *
...
// promoted.
const BM152_REQUIRED_FIELD_PATHS = [] as const;

export const BM152_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-152",
  title: "Biểu mẫu BM-152",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM152_FIELD_PATHS,
  requiredFieldPaths: BM152_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-152 anchors must
...
registerFormFlightProfile(BM152_FORM_FLIGHT_PROFILE);
