 ...
 * contract `docs\audit\docx\contracts\locked\BM-143__7ad54f65b3a0.contract.locked.json`.
 *
...
// promoted.
const BM143_REQUIRED_FIELD_PATHS = [] as const;

export const BM143_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-143",
  title: "Biểu mẫu BM-143",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM143_FIELD_PATHS,
  requiredFieldPaths: BM143_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-143 anchors must
...
registerFormFlightProfile(BM143_FORM_FLIGHT_PROFILE);
