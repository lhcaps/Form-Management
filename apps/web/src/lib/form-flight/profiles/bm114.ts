 ...
 * contract `docs\audit\docx\contracts\locked\BM-114__84cec283ce1b.contract.locked.json`.
 *
...
// promoted.
const BM114_REQUIRED_FIELD_PATHS = [] as const;

export const BM114_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-114",
  title: "Biểu mẫu BM-114",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM114_FIELD_PATHS,
  requiredFieldPaths: BM114_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-114 anchors must
...
registerFormFlightProfile(BM114_FORM_FLIGHT_PROFILE);
