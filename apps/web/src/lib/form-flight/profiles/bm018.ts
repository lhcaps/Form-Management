 ...
 * contract `docs\audit\docx\contracts\locked\BM-018__fe8c39468552.contract.locked.json`.
 *
...
// promoted.
const BM018_REQUIRED_FIELD_PATHS = [] as const;

export const BM018_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-018",
  title: "Biểu mẫu BM-018",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM018_FIELD_PATHS,
  requiredFieldPaths: BM018_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-018 anchors must
...
registerFormFlightProfile(BM018_FORM_FLIGHT_PROFILE);
