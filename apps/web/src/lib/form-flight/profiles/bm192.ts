 ...
 * contract `docs\audit\docx\contracts\locked\BM-192__42db503bed2a.contract.locked.json`.
 *
...
// promoted.
const BM192_REQUIRED_FIELD_PATHS = [] as const;

export const BM192_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-192",
  title: "Biểu mẫu BM-192",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM192_FIELD_PATHS,
  requiredFieldPaths: BM192_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-192 anchors must
...
registerFormFlightProfile(BM192_FORM_FLIGHT_PROFILE);
