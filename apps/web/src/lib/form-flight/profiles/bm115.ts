 ...
 * contract `docs\audit\docx\contracts\locked\BM-115__94659bf76001.contract.locked.json`.
 *
...
// promoted.
const BM115_REQUIRED_FIELD_PATHS = [] as const;

export const BM115_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-115",
  title: "Biểu mẫu BM-115",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM115_FIELD_PATHS,
  requiredFieldPaths: BM115_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-115 anchors must
...
registerFormFlightProfile(BM115_FORM_FLIGHT_PROFILE);
