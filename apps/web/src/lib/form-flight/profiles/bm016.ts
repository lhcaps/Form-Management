 ...
 * contract `docs\audit\docx\contracts\locked\BM-016__565ec1fc2103.contract.locked.json`.
 *
...
// promoted.
const BM016_REQUIRED_FIELD_PATHS = [] as const;

export const BM016_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-016",
  title: "Biểu mẫu BM-016",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM016_FIELD_PATHS,
  requiredFieldPaths: BM016_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-016 anchors must
...
registerFormFlightProfile(BM016_FORM_FLIGHT_PROFILE);
