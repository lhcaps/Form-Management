 ...
 * contract `docs\audit\docx\contracts\locked\BM-173__2e06ac25958d.contract.locked.json`.
 *
...
// promoted.
const BM173_REQUIRED_FIELD_PATHS = [] as const;

export const BM173_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-173",
  title: "Biểu mẫu BM-173",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM173_FIELD_PATHS,
  requiredFieldPaths: BM173_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-173 anchors must
...
registerFormFlightProfile(BM173_FORM_FLIGHT_PROFILE);
