 ...
 * contract `docs\audit\docx\contracts\locked\BM-176__8f1b057e17a7.contract.locked.json`.
 *
...
// promoted.
const BM176_REQUIRED_FIELD_PATHS = [] as const;

export const BM176_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-176",
  title: "Biểu mẫu BM-176",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM176_FIELD_PATHS,
  requiredFieldPaths: BM176_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-176 anchors must
...
registerFormFlightProfile(BM176_FORM_FLIGHT_PROFILE);
