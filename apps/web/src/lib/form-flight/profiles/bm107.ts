 ...
 * contract `docs\audit\docx\contracts\locked\BM-107__9b3379af7cfe.contract.locked.json`.
 *
...
// promoted.
const BM107_REQUIRED_FIELD_PATHS = [] as const;

export const BM107_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-107",
  title: "Biểu mẫu BM-107",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM107_FIELD_PATHS,
  requiredFieldPaths: BM107_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-107 anchors must
...
registerFormFlightProfile(BM107_FORM_FLIGHT_PROFILE);
