 ...
 * contract `docs\audit\docx\contracts\locked\BM-134__7c1e123c01b0.contract.locked.json`.
 *
...
// promoted.
const BM134_REQUIRED_FIELD_PATHS = [] as const;

export const BM134_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-134",
  title: "Biểu mẫu BM-134",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM134_FIELD_PATHS,
  requiredFieldPaths: BM134_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-134 anchors must
...
registerFormFlightProfile(BM134_FORM_FLIGHT_PROFILE);
