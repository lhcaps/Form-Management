 ...
 * contract `docs\audit\docx\contracts\locked\BM-117__c9531f5e460e.contract.locked.json`.
 *
...
// promoted.
const BM117_REQUIRED_FIELD_PATHS = [] as const;

export const BM117_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-117",
  title: "Biểu mẫu BM-117",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM117_FIELD_PATHS,
  requiredFieldPaths: BM117_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-117 anchors must
...
registerFormFlightProfile(BM117_FORM_FLIGHT_PROFILE);
