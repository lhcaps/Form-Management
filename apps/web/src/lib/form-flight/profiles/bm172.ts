 ...
 * contract `docs\audit\docx\contracts\locked\BM-172__e3a3eb687d2f.contract.locked.json`.
 *
...
// promoted.
const BM172_REQUIRED_FIELD_PATHS = [] as const;

export const BM172_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-172",
  title: "Biểu mẫu BM-172",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM172_FIELD_PATHS,
  requiredFieldPaths: BM172_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-172 anchors must
...
registerFormFlightProfile(BM172_FORM_FLIGHT_PROFILE);
