 ...
 * contract `docs\audit\docx\contracts\locked\BM-164__04fa37dd8384.contract.locked.json`.
 *
...
// promoted.
const BM164_REQUIRED_FIELD_PATHS = [] as const;

export const BM164_FORM_FLIGHT_PROFILE: FormFlightProfile = {
  templateCode: "BM-164",
  title: "Biểu mẫu BM-164",
  // SKELETON: never runtime-ready. Adapter helpers skip this profile.
  runtimeReady: false,
  profileStatus: "skeleton",
  fieldPaths: BM164_FIELD_PATHS,
  requiredFieldPaths: BM164_REQUIRED_FIELD_PATHS,
  // SKELETON: empty demo. Hand-curated fixture required before any
  // `runtime-ready` promotion.
  demo: {},
  // SKELETON: empty acceptance contract. Real BM-164 anchors must
...
registerFormFlightProfile(BM164_FORM_FLIGHT_PROFILE);
