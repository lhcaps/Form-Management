...
const BM089_FIELDS = {
  "agency.vienKiem": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-089)",
  },
} as const;

const BM089_DEMO_RUNTIME_UX = {
  "agency.vienKiem": "Tên cơ quan (mẫu BM-089)",
} as const;

const BM089_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  templateCode: "BM-089",
  // Stable version label, surfaced in audit artifacts.
  versionLabel: `BM-089 runtime-ux auto-generated conservative profile`,
  sections: BM089_SECTIONS,
  fields: BM089_FIELDS,
  demo: BM089_DEMO_RUNTIME_UX,
};
