...
const BM077_FIELDS = {
  "agency.name": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-077)",
  },
  "document.fullDocumentCode": {
    label: "Số văn bản / quyết định",
    placeholder: "Số văn bản / quyết định (mẫu BM-077)",
  },
} as const;

const BM077_DEMO_RUNTIME_UX = {
  "agency.name": "Tên cơ quan (mẫu BM-077)",
  "document.fullDocumentCode": "Số văn bản / quyết định (mẫu BM-077)",
} as const;

const BM077_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  templateCode: "BM-077",
  // Stable version label, surfaced in audit artifacts.
  versionLabel: `BM-077 runtime-ux auto-generated conservative profile`,
  sections: BM077_SECTIONS,
  fields: BM077_FIELDS,
  demo: BM077_DEMO_RUNTIME_UX,
};
