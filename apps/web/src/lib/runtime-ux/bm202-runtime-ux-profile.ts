...
const BM202_FIELDS = {
  ...
  "decision.decisionLine": {
    label: "Cơ quan ra quyết định (dòng)",
    placeholder: "Cơ quan ra quyết định (dòng) ",
  },
  "document.issueDate": {
    label: "Ngày ban hành",
...
const BM202_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  ...
  versionLabel: `BM-202 runtime-ux remaining curated source-render profile`,
  sections: BM202_SECTIONS,
  fields: BM202_FIELDS,
  demo: BM202_DEMO_RUNTIME_UX,
};
