...
const BM101_FIELDS = {
  "agency.vienKiem": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-101)",
  },
  "document.soQuyet": {
    label: "Số quyết định",
    placeholder: "Số quyết định (mẫu BM-101)",
  },
  "agency.diaDanh": {
    label: "Địa danh",
    placeholder: "Địa danh (mẫu BM-101)",
  },
  "document.ngayBan": {
    label: "Ngày ban hành",
    placeholder: "Ngày ban hành (mẫu BM-101)",
  },
  "agency.dongDia": {
    label: "Dòng địa danh",
    placeholder: "Dòng địa danh (mẫu BM-101)",
  },
} as const;

const BM101_DEMO_RUNTIME_UX = {
...
const BM101_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  ...
  versionLabel: `BM-101 runtime-ux batch 5 curated source-render profile`,
  sections: BM101_SECTIONS,
  fields: BM101_FIELDS,
  demo: BM101_DEMO_RUNTIME_UX,
};
