...
const BM099_FIELDS = {
  "agency.vienKiem": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-099)",
  },
  "document.soQuyet": {
    label: "Số quyết định",
    placeholder: "Số quyết định (mẫu BM-099)",
  },
} as const;

const BM099_DEMO_RUNTIME_UX = {
  "agency.vienKiem": "Tên cơ quan (mẫu BM-099)",
  "document.soQuyet": "Số quyết định (mẫu BM-099)",
} as const;

const BM099_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  templateCode: "BM-099",
  // Stable version label, surfaced in audit artifacts.
  versionLabel: `BM-099 runtime-ux auto-generated conservative profile`,
  sections: BM099_SECTIONS,
  fields: BM099_FIELDS,
  demo: BM099_DEMO_RUNTIME_UX,
};
