...
const BM106_FIELDS = {
  "agency.vienKiem": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-106)",
  },
  "recipients.personLine": {
    label: "Người bị áp dụng",
    placeholder: "Người bị áp dụng (mẫu BM-106)",
  },
  "document.soQuyet": {
    label: "Số quyết định",
    placeholder: "Số quyết định (mẫu BM-106)",
  },
  "agency.diaDanh": {
    label: "Địa danh",
    placeholder: "Địa danh (mẫu BM-106)",
  },
  "document.ngayBan": {
    label: "Ngày ban hành",
    placeholder: "Ngày ban hành (mẫu BM-106)",
  },
  "agency.dongDia": {
    label: "Dòng địa danh",
    placeholder: "Dòng địa danh (mẫu BM-106)",
  },
  "document.chuThe": {
    label: "Chủ thể liên quan",
    placeholder: "Chủ thể liên quan (mẫu BM-106)",
  },
  "document.tenVu": {
    label: "Tên vụ án / vụ việc",
    placeholder: "Tên vụ án / vụ việc (mẫu BM-106)",
  },
  "person.toiDanh": {
    label: "Tội danh",
    placeholder: "Tội danh (mẫu BM-106)",
  },
  "document.thoiHan": {
    label: "Thời hạn",
    placeholder: "Thời hạn (mẫu BM-106)",
  },
  "document.lyDo": {
    label: "Lý do",
    placeholder: "Lý do (mẫu BM-106)",
  },
} as const;
...
const BM106_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  ...
  versionLabel: `BM-106 runtime-ux batch 5 curated source-render profile`,
