...
const BM110_FIELDS = {
  "agency.vienKiem": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-110)",
  },
  "document.soQuyet": {
    label: "Số quyết định",
    placeholder: "Số quyết định (mẫu BM-110)",
  },
  "agency.diaDanh": {
    label: "Địa danh",
    placeholder: "Địa danh (mẫu BM-110)",
  },
} as const;
...
const BM110_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  ...
  versionLabel: `BM-110 runtime-ux batch 5 curated source-render profile`,
