...
const BM082_FIELDS = {
  "agency.name": {
    label: "Tên cơ quan",
    placeholder: "Tên cơ quan (mẫu BM-082)",
  },
  "document.fullDocumentCode": {
    label: "Số văn bản / quyết định",
    placeholder: "Số văn bản / quyết định (mẫu BM-082)",
  },
} as const;

const BM082_DEMO_RUNTIME_UX = {
  "agency.name": "Tên cơ quan (mẫu BM-082)",
  "document.fullDocumentCode": "Số văn bản / quyết định (mẫu BM-082)",
} as const;

const BM082_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  templateCode: "BM-082",
  // Stable version label, surfaced in audit artifacts.
  versionLabel: `BM-082 runtime-ux auto-generated conservative profile`,
  sections: BM082_SECTIONS,
  fields: BM082_FIELDS,
  demo: BM082_DEMO_RUNTIME_UX,
};
