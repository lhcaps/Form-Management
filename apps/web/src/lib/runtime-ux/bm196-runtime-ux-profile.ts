...
const BM196_FIELDS = {
  ...
  "document.reasonLine": {
    label: "Căn cứ / lý do (dòng)",
    placeholder: "Căn cứ / lý do (dòng) ",
  },
  "document.issuePlace": {
    label: "Nơi ban hành",
...
const BM196_RUNTIME_UX_PROFILE: RuntimeUxProfile = {
  ...
  versionLabel: `BM-196 runtime-ux remaining curated source-render profile`,
