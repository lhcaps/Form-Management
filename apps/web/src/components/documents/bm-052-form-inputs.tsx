...
export function Bm052FormInputsPanel({ documentId, onSaved }: Props) {
  ...
  return (
    <div className="space-y-4">
      <BmFormMetaBar
        ...
        subtitle={`Biểu mẫu TT 03/2026-VKSTC · Stage: BP_NGAN_CHAN (Biện pháp ngăn chặn, bảo đảm) · Group: G02 · Scope: ${scope}`}
        templateCode="BM-052"
        isDirty={isDirty}
        isLoading={isLoading}
        errorMessage={error}
        ...
        meta={
          <div className="text-xs text-slate-500">
            <div>Stage: <span className="font-mono">BP_NGAN_CHAN</span></div>
