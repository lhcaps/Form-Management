...
export function Bm008FormInputsPanel({
  ...
  return (
    <div className="grid gap-4">
      <BmFormCasePayloadButton templateCode="BM-008" form={form} onApply={(next) => setForm(next as typeof form)} />
      ...
      <BmFormSection title="Cơ quan / số văn bản">
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <BmFieldText label="Số yêu cầu" value={form.document.documentCode} onChange={(value) => updateGroup("document", "documentCode", value)} fullWidth />
      ...
      <BmFormSection title="Nội dung chuyển nguồn tin">
        <div className="grid gap-3 md:grid-cols-2">
        ...
        <div className="mt-3 grid gap-3">
          <BmFieldTextarea label="Hồ sơ vụ việc" value={form.sourceTransfer.caseSummary} onChange={(value) => updateGroup("sourceTransfer", "caseSummary", value)} fullWidth />

          <BmFieldTextarea label="Lý do chuyển" value={form.sourceTransfer.reasonLine} onChange={(value) => updateGroup("sourceTransfer", "reasonLine", value)} fullWidth />

          <BmFieldText label="Cơ quan/người chuyển" value={form.sourceTransfer.senderName} onChange={(value) => updateGroup("sourceTransfer", "senderName", value)} fullWidth />

          <BmFieldText label="Cơ quan/người tiếp nhận" value={form.sourceTransfer.receiverName} onChange={(value) => updateGroup("sourceTransfer", "receiverName", value)} fullWidth />
        </div>
      </BmFormSection>
