...
CREATE TABLE `form_contract_versions` (
    ...
    UNIQUE INDEX `uq_form_contract_scope_version`(`template_id`, `scope_key`, `version_no`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `official_permissions` (
    ...
    UNIQUE INDEX `uq_official_permission_scope`(`official_id`, `scope_key`, `permission_code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `auth_identity_audit_logs` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `actor_official_id` BIGINT UNSIGNED NOT NULL,
    `action` VARCHAR(64) NOT NULL,
...
CREATE TABLE `auth_identities` (
    ...
    UNIQUE INDEX `uq_auth_identities_provider_user`(`provider`, `provider_user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `generated_document_audit_logs` ADD CONSTRAINT `fk_gen_doc_audit_actor` FOREIGN KEY (`actor_official_id`) REFERENCES `officials`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `generated_document_audit_logs` ADD CONSTRAINT `fk_gen_doc_audit_agency` FOREIGN KEY (`agency_id`) REFERENCES `agencies`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `generated_document_audit_logs` ADD CONSTRAINT `fk_gen_doc_audit_case` FOREIGN KEY (`case_id`) REFERENCES `cases`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `generated_document_audit_logs` ADD CONSTRAINT `fk_gen_doc_audit_document` FOREIGN KEY (`generated_document_id`) REFERENCES `generated_documents`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `generated_document_audit_logs` ADD CONSTRAINT `fk_gen_doc_audit_file` FOREIGN KEY (`generated_document_file_id`) REFERENCES `generated_document_files`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `form_contract_versions` ADD CONSTRAINT `fk_form_contract_versions_template` FOREIGN KEY (`template_id`) REFERENCES `templates`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_versions` ADD CONSTRAINT `fk_form_contract_versions_agency` FOREIGN KEY (`agency_id`) REFERENCES `agencies`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_versions` ADD CONSTRAINT `fk_form_contract_versions_creator` FOREIGN KEY (`created_by_official_id`) REFERENCES `officials`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_versions` ADD CONSTRAINT `fk_form_contract_versions_approver` FOREIGN KEY (`approved_by_official_id`) REFERENCES `officials`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_versions` ADD CONSTRAINT `fk_form_contract_versions_publisher` FOREIGN KEY (`published_by_official_id`) REFERENCES `officials`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_revisions` ADD CONSTRAINT `fk_form_contract_revisions_version` FOREIGN KEY (`contract_version_id`) REFERENCES `form_contract_versions`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_revisions` ADD CONSTRAINT `fk_form_contract_revisions_actor` FOREIGN KEY (`actor_official_id`) REFERENCES `officials`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_reviews` ADD CONSTRAINT `fk_form_contract_reviews_version` FOREIGN KEY (`contract_version_id`) REFERENCES `form_contract_versions`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_contract_reviews` ADD CONSTRAINT `fk_form_contract_reviews_actor` FOREIGN KEY (`actor_official_id`) REFERENCES `officials`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_preview_jobs` ADD CONSTRAINT `fk_form_preview_jobs_version` FOREIGN KEY (`contract_version_id`) REFERENCES `form_contract_versions`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `form_preview_jobs` ADD CONSTRAINT `fk_form_preview_jobs_requester` FOREIGN KEY (`requested_by_official_id`) REFERENCES `officials`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `official_permissions` ADD CONSTRAINT `fk_official_permissions_official` FOREIGN KEY (`official_id`) REFERENCES `officials`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `official_permissions` ADD CONSTRAINT `fk_official_permissions_grantor` FOREIGN KEY (`granted_by_official_id`) REFERENCES `officials`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `official_permissions` ADD CONSTRAINT `fk_official_permissions_agency` FOREIGN KEY (`agency_id`) REFERENCES `agencies`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `auth_identity_audit_logs` ADD CONSTRAINT `fk_auth_identity_audit_identity` FOREIGN KEY (`identity_id`) REFERENCES `auth_identities`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `auth_identity_audit_logs` ADD CONSTRAINT `fk_auth_identity_audit_actor` FOREIGN KEY (`actor_official_id`) REFERENCES `officials`(`id`) ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `auth_identities` ADD CONSTRAINT `fk_auth_identities_official` FOREIGN KEY (`official_id`) REFERENCES `officials`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
