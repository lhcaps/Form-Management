...
# RC-008: Standalone output — copies only what Next.js traced as needed.
# No workspace node_modules, no pnpm, no full monorepo layout.
# Image size: ~300-400 MB vs ~1.2 GB before.

# form-contracts dist is referenced by the standalone bundle
...
# Standalone server: generated by Next.js at .next/standalone/apps/web/server.js
CMD ["node", "server.js"]
