...
const demoMatch = profileSrc.match(/const BM171_DEMO = \{([\s\S]*?)as const;/);
if (!demoMatch) {
  console.error('[FAIL] BM171_DEMO not found in profile source');
  process.exit(1);
}
const BM171_DEMO = new Function(`return ({${demoMatch[1]}});`)();
const BM171_DEMO_KEYS = Object.keys(BM171_DEMO);
  ...
  JSON.stringify(
    {
      ...
      nestedState,
      producedFromProfile: 'bm171-runtime-ux-profile.ts BM171_DEMO',
...
// 5. Extract visible text (mirrors script-side extraction in
  ...
  JSON.stringify(
    {
      ...
      fixtureSource: 'apps/web/src/lib/runtime-ux/bm171-runtime-ux-profile.ts BM171_DEMO',
