...
| FMT-002 | Header: VIỆN KIỂM SÁT NHÂN DÂN THÀNH PHỐ HỒ CHÍ MINH | `not_detectable` | - |
| FMT-003 | Header: VIỆN KIỂM SÁT NHÂN DÂN KHU VỰC 7 bold | `not_detectable` | - |
...
| FMT-012 | Điều 1, Điều 2, or section headings 1., 2. bold | `pass` | 2/2 Điều/section runs are bold |
