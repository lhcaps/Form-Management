/**
 * Authenticated preview-click smoke for the 20 Batch 3 INPUT_CONNECTED_PASS
 * forms (BM-055..BM-069, BM-071..BM-075).
 *
 * Companion to:
 *   - tests/e2e/curated-batch3-templates.auth.spec.ts    (visibility)
 ...
 *
 * This spec clicks "Xem trước bản in" for each Batch 3 code and asserts the
 * runtime-preview-session lifecycle contract end-to-end (same contract as the
 * curated 37 spec — see that file for the full rationale):
 *
 ...
 *      preview-session POST (same root cause as curated 37).
 ...
 *     tests/e2e/curated-batch3-preview-click.auth.spec.ts \
...
test.describe("Curated Batch 3 — authenticated preview-click smoke", () => {
