#!/usr/bin/env node
/**
 * parse-batch3-preview-click.mjs
 *
 ...
 *
 * Usage:
 *   node scripts/audit/parse-batch3-preview-click.mjs <input.json> <output.json>
 */
...
if (!inPath || !outPath) {
  console.error(
    "usage: parse-batch3-preview-click.mjs <input.json> <output.json>",
  );
  process.exit(2);
}
