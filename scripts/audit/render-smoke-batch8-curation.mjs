#!/usr/bin/env node
/**
 * Batch 8 source/render profile smoke.
 *
 * Read-only, local-file audit. It verifies the selected Batch 8 runtime UX
...
const OUT_JSON = `${OUT_DIR}/QLLAW_BATCH8_SOURCE_RENDER_SMOKE.latest.json`;
const OUT_MD = `${OUT_DIR}/QLLAW_BATCH8_SOURCE_RENDER_SMOKE.latest.md`;
...
const lines = [];
lines.push("# QLLAW Batch 8 Source/Render Smoke - latest");
lines.push("");
