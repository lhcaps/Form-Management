...
const DOCX_OUT = path.join("D:/Study/Project/QLLaw-main", "storage", "templates", "normalized-docx");
const LOCKED_DIR = path.join("D:/Study/Project/QLLaw-main", "docs", "audit", "docx", "contracts", "locked");
