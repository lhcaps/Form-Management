# BM-063 Contract Repair Patch Plan
...
| --- | --- | --- | --- |
| REVIEW_RENORMALIZE_DUPLICATE_DOCX_PLACEHOLDER | document.fullDocumentCode8 | false | The same numbered DOCX placeholder appears in multiple visible semantic contexts; renormalize the DOCX placeholders before contract add/relink/remove. |
| REVIEW_RENORMALIZE_DUPLICATE_DOCX_PLACEHOLDER | recipients.personLine5 | false | The same numbered DOCX placeholder appears in multiple visible semantic contexts; renormalize the DOCX placeholders before contract add/relink/remove. |
